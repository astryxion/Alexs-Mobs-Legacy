...
/**
 * Same behavior as {@link net.minecraft.entity.ai.EntityAITempt}, but usable with
 * {@link net.minecraft.pathfinding.PathNavigateFlying} (vanilla TemptGoal requires ground navigation).
 */
public class FlyingEntityAITempt extends EntityAIBase {
    ...
    public FlyingEntityAITempt(EntityCreature temptedEntityIn, double speedIn, Item temptItemIn, boolean scaredByPlayerMovementIn) {
        this(temptedEntityIn, speedIn, scaredByPlayerMovementIn, Sets.newHashSet(temptItemIn));
    }

    public FlyingEntityAITempt(EntityCreature temptedEntityIn, double speedIn, boolean scaredByPlayerMovementIn, Set<Item> temptItemIn) {
