...
public class AnimalAIFindWaterLava extends EntityAIBase {
    private final EntityCreature creature;
    private BlockPos targetPos;
    private int executionChance = 30;

    public AnimalAIFindWaterLava(EntityCreature creature) {
    ...
    public boolean shouldExecute() {
        if (this.creature.onGround && !isLiquidAt(this.creature.getPosition())) {
    ...
    public boolean shouldContinueExecuting() {
        ...
        return !this.creature.getNavigator().noPath() && targetPos != null && !isLiquidAt(this.creature.getPosition());
    }
