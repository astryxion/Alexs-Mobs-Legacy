...
public class EntityMosquitoSpit extends Entity {
    ...
    public EntityMosquitoSpit(World worldIn) {
        super(worldIn);
        this.setSize(0.5F, 0.5F);
    }

    public EntityMosquitoSpit(World worldIn, EntityCrimsonMosquito shooter) {
        this(worldIn);
    ...
    public EntityMosquitoSpit(World worldIn, EntityLivingBase shooter, boolean right) {
        this(worldIn);
        this.setShooter(shooter);
    ...
    public EntityMosquitoSpit(World worldIn, double x, double y, double z, double motX, double motY, double motZ) {
        this(worldIn);
    ...
    protected void onEntityHit(RayTraceResult result) {
        ...
        if (shooter instanceof EntityLivingBase) {
            hitEntity.attackEntityFrom(DamageSource.causeIndirectDamage(this, (EntityLivingBase) shooter), 4.0F);
        }
