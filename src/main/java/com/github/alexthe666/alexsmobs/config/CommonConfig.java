...
public class CommonConfig {
    ...
    public final ConfigHolder.FCInt hummingbirdSpawnRolls = i("S", "hummingbirdSpawnRolls", 1, 0, 2147483647, "Random roll chance to enable mob spawning. Higher number = lower chance of spawning");
    ...
    public final ConfigHolder.FCInt jerboaSpawnWeight = i("S", "jerboaSpawnWeight", 10, 0, 1000, "Spawn enable gate for Jerboa (FF pool weight is separate). 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt triopsSpawnWeight = i("S", "triopsSpawnWeight", 6, 0, 1000, "Spawn enable gate for Triops. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt terrapinSpawnWeight = i("S", "terrapinSpawnWeight", 5, 0, 1000, "Spawn enable gate for Terrapin. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt potooSpawnWeight = i("S", "potooSpawnWeight", 8, 0, 1000, "Spawn enable gate for Potoo. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt toucanSpawnWeight = i("S", "toucanSpawnWeight", 10, 0, 1000, "Spawn enable gate for Toucan. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt flyingFishSpawnWeight = i("S", "flyingFishSpawnWeight", 6, 0, 1000, "Spawn enable gate for Flying Fish. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt catfishSpawnWeight = i("S", "catfishSpawnWeight", 5, 0, 1000, "Spawn enable gate for Catfish. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt sugarGliderSpawnWeight = i("S", "sugarGliderSpawnWeight", 8, 0, 1000, "Spawn enable gate for Sugar Glider. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt geladaMonkeySpawnWeight = i("S", "geladaMonkeySpawnWeight", 6, 0, 1000, "Spawn enable gate for Gelada Monkey. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt caimanSpawnWeight = i("S", "caimanSpawnWeight", 12, 0, 1000, "Spawn enable gate for Caiman. 0 = disable spawn");
    ...
    public final ConfigHolder.FCInt geladaMonkeySpawnHeight = i("G", "geladaMonkeySpawnHeight", 100, -64, 256, "Minimum world y-level that gelada monkeys can spawn at");
