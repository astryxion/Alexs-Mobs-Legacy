...
public class AMConfig {
    ...
    public static int jerboaSpawnWeight = 10;
    public static int jerboaSpawnRolls = 2;
    public static int triopsSpawnWeight = 6;
    public static int triopsSpawnRolls = 0;
    public static int terrapinSpawnWeight = 5;
    ...
    public static int potooSpawnWeight = 8;
    public static int potooSpawnRolls = 0;
    public static int toucanSpawnWeight = 10;
    public static int toucanSpawnRolls = 0;
    public static int flyingFishSpawnWeight = 6;
    public static int flyingFishSpawnRolls = 0;
    public static int catfishSpawnWeight = 5;
    public static int catfishSpawnRolls = 1;
    public static int sugarGliderSpawnWeight = 8;
    public static int sugarGliderSpawnRolls = 0;
    public static int geladaMonkeySpawnWeight = 6;
    ...
    public static int caimanSpawnWeight = 12;
    ...
    public static void bake() {
        try {
            ...
            pupfishSpawnWeight = ConfigHolder.COMMON.pupfishSpawnWeight.get();
            pupfishSpawnRolls = ConfigHolder.COMMON.pupfishSpawnRolls.get();
