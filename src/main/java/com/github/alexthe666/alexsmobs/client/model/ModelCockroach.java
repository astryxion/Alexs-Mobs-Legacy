...
public class ModelCockroach extends AdvancedEntityModel<EntityCockroach> {
    ...
    public ModelCockroach() {
        ...
        abdomen.setTextureOffset(0, 12).func_228303_a_(-2.0F, -0.9F, -2.0F, 4.0F, 2.0F, 9.0F, 0.0F, false);
        ...
        left_leg_front.setTextureOffset(0, 24).func_228303_a_(0.0F, 0.0F, 0.0F, 7.0F, 0.0F, 3.0F, 0.0F, false);
        ...
        right_leg_front.setTextureOffset(0, 24).func_228303_a_(-7.0F, 0.0F, 0.0F, 7.0F, 0.0F, 3.0F, 0.0F, true);
        ...
        left_leg_back.setTextureOffset(18, 12).func_228303_a_(0.0F, 0.0F, 0.0F, 7.0F, 0.0F, 5.0F, 0.0F, false);
        ...
        right_leg_back.setTextureOffset(18, 12).func_228303_a_(-7.0F, 0.0F, 0.0F, 7.0F, 0.0F, 5.0F, 0.0F, true);
        ...
        left_leg_mid.setTextureOffset(23, 20).func_228303_a_(0.0F, 0.0F, 0.0F, 7.0F, 0.0F, 4.0F, 0.0F, false);
        ...
        right_leg_mid.setTextureOffset(23, 20).func_228303_a_(-7.0F, 0.0F, 0.0F, 7.0F, 0.0F, 4.0F, 0.0F, true);

        left_wing = new AdvancedModelBox(this);
        left_wing.setRotationPoint(0.0F, -1.4F, -2.0F);
        abdomen.addChild(left_wing);
        left_wing.setTextureOffset(0, 0).func_228303_a_(0.0F, 0.0F, 0.0F, 3.0F, 1.0F, 10.0F, 0.0F, false);

        right_wing = new AdvancedModelBox(this);
        right_wing.setRotationPoint(0.0F, -1.4F, -2.0F);
        abdomen.addChild(right_wing);
        right_wing.setTextureOffset(0, 0).func_228303_a_(-3.0F, 0.0F, 0.0F, 3.0F, 1.0F, 10.0F, 0.0F, true);

        neck = new AdvancedModelBox(this);
        neck.setRotationPoint(0.0F, 0.0F, -2.0F);
        abdomen.addChild(neck);
        neck.setTextureOffset(21, 25).func_228303_a_(-2.5F, -1.6F, -2.0F, 5.0F, 3.0F, 2.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -0.1F, -2.0F);
        neck.addChild(head);
        head.setTextureOffset(0, 28).func_228303_a_(-1.5F, -1.0F, -2.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        left_antenna.setTextureOffset(17, 0).func_228303_a_(0.0F, 0.0F, -8.0F, 5.0F, 0.0F, 8.0F, 0.0F, false);
        ...
        right_antenna.setTextureOffset(17, 0).func_228303_a_(-5.0F, 0.0F, -8.0F, 5.0F, 0.0F, 8.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCockroach) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
