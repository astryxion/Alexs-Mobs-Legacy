...
public class ModelBoneSerpentTail extends AdvancedEntityModel<EntityBoneSerpentPart> {
    ...
    public ModelBoneSerpentTail() {
        ...
        root.addChild(tail);
        tail.setTextureOffset(0, 0).func_228303_a_(-5.0F, -5.25F, -8.0F, 10.0F, 10.0F, 16.0F, 0.0F, false);
        tail.setTextureOffset(0, 27).func_228303_a_(-1.0F, -6.25F, -8.0F, 2.0F, 1.0F, 16.0F, 0.0F, false);
