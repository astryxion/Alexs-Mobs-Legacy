...
public class ModelVoidWorm extends AdvancedEntityModel<EntityVoidWorm> {
	...
	public ModelVoidWorm() {
		...
		root.addChild(neck);
		neck.setTextureOffset(0, 53).func_228303_a_(-10.0F, -10.0F, -28.0F, 20.0F, 20.0F, 28.0F, 0.0F, false);
		...
		topfrills_left.setTextureOffset(71, 76).func_228303_a_(0.0F, -9.0F, -7.0F, 0.0F, 9.0F, 26.0F, 0.0F, false);
		...
		topfrills_right.setTextureOffset(71, 76).func_228303_a_(0.0F, -9.0F, -7.0F, 0.0F, 9.0F, 26.0F, 0.0F, true);
		...
		bottomfrills_left.setTextureOffset(71, 76).func_228303_a_(0.0F, -9.0F, -7.0F, 0.0F, 9.0F, 26.0F, 0.0F, false);
		...
		bottomfrills_right.setTextureOffset(71, 76).func_228303_a_(0.0F, -9.0F, -7.0F, 0.0F, 9.0F, 26.0F, 0.0F, true);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, 0.0F, -28.0F);
		neck.addChild(head);
		head.setTextureOffset(0, 0).func_228303_a_(-17.0F, -17.0F, -18.0F, 34.0F, 34.0F, 18.0F, 0.0F, false);
		head.setTextureOffset(25, 102).func_228303_a_(17.0F, -5.0F, -14.0F, 2.0F, 10.0F, 10.0F, 0.0F, false);
		head.setTextureOffset(0, 102).func_228303_a_(-19.0F, -5.0F, -14.0F, 2.0F, 10.0F, 10.0F, 0.0F, false);
		...
		eye_bottom_r1.setTextureOffset(0, 53).func_228303_a_(-1.0F, -5.0F, -5.0F, 2.0F, 10.0F, 10.0F, 0.0F, false);
		...
		eye_top_r1.setTextureOffset(69, 54).func_228303_a_(-1.0F, -5.0F, -5.0F, 2.0F, 10.0F, 10.0F, 0.0F, false);

		topjaw = new AdvancedModelBox(this);
		topjaw.setRotationPoint(0.0F, 3.0F, -18.0F);
		head.addChild(topjaw);
		topjaw.setTextureOffset(98, 64).func_228303_a_(-5.0F, -10.0F, -16.0F, 10.0F, 10.0F, 16.0F, 0.0F, false);

		bottomjaw = new AdvancedModelBox(this);
		bottomjaw.setRotationPoint(0.0F, -3.0F, -17.9F);
		head.addChild(bottomjaw);
		bottomjaw.setTextureOffset(89, 37).func_228303_a_(-5.0F, 0.0F, -16.0F, 10.0F, 10.0F, 16.0F, -0.1F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityVoidWorm) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
