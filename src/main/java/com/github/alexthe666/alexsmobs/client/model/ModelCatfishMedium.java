...
public class ModelCatfishMedium extends AdvancedEntityModel<EntityCatfish> {
    ...
    public ModelCatfishMedium() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-7.0F, -6.0F, -10.0F, 14.0F, 11.0F, 18.0F, 0.0F, false);

        dorsal_fin = new AdvancedModelBox(this, "dorsal_fin");
        dorsal_fin.setRotationPoint(0.0F, -6.0F, 0.0F);
        body.addChild(dorsal_fin);
        dorsal_fin.setTextureOffset(0, 0).func_228303_a_(0.0F, -4.0F, -1.0F, 0.0F, 4.0F, 7.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(0, 30).func_228303_a_(0.0F, 0.0F, -1.0F, 0.0F, 3.0F, 5.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(0, 30).func_228303_a_(0.0F, 0.0F, -1.0F, 0.0F, 3.0F, 5.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -2.0F, 9.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 30).func_228303_a_(-5.0F, -4.0F, -1.0F, 10.0F, 8.0F, 19.0F, 0.0F, false);
        tail.setTextureOffset(53, 18).func_228303_a_(0.0F, 4.0F, 1.0F, 0.0F, 4.0F, 12.0F, 0.0F, false);
        tail.setTextureOffset(8, 0).func_228303_a_(0.0F, -6.0F, 4.0F, 0.0F, 2.0F, 4.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this, "tail_fin");
        tail_fin.setRotationPoint(0.0F, -4.0F, 17.0F);
        tail.addChild(tail_fin);
        tail_fin.setTextureOffset(38, 37).func_228303_a_(0.0F, -3.0F, -6.0F, 0.0F, 13.0F, 21.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -1.0F, -11.0F);
        body.addChild(head);
        head.setTextureOffset(47, 0).func_228303_a_(-6.0F, -5.0F, -5.0F, 12.0F, 9.0F, 6.0F, 0.0F, false);
        ...
        left_BigWhisker.setTextureOffset(0, 12).func_228303_a_(0.0F, 0.0F, 0.0F, 8.0F, 5.0F, 0.0F, 0.0F, false);
        ...
        right_BigWhisker.setTextureOffset(0, 12).func_228303_a_(-8.0F, 0.0F, 0.0F, 8.0F, 5.0F, 0.0F, 0.0F, true);
        ...
        left_SmallWhisker.setTextureOffset(6, 30).func_228303_a_(0.0F, 0.0F, 0.0F, 5.0F, 3.0F, 0.0F, 0.0F, false);
        ...
        right_SmallWhisker.setTextureOffset(6, 30).func_228303_a_(-5.0F, 0.0F, 0.0F, 5.0F, 3.0F, 0.0F, 0.0F, true);
