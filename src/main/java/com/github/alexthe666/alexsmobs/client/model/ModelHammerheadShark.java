...
public class ModelHammerheadShark extends AdvancedEntityModel<EntityHammerheadShark> {
	...
	public ModelHammerheadShark() {
		...
		main_body.setTextureOffset(0, 0).func_228303_a_(-5.0F, -4.0F, -14.0F, 10.0F, 10.0F, 25.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -1.0F, -14.5F);
		main_body.addChild(head);
		head.setTextureOffset(40, 55).func_228303_a_(-4.0F, -1.0F, -6.5F, 8.0F, 7.0F, 7.0F, 0.0F, false);

		head_hammer = new AdvancedModelBox(this);
		head_hammer.setRotationPoint(0.0F, 1.5F, -7.0F);
		head.addChild(head_hammer);
		head_hammer.setTextureOffset(32, 36).func_228303_a_(-11.0F, -1.5F, -3.5F, 22.0F, 3.0F, 7.0F, 0.0F, false);
		...
		finL.setTextureOffset(47, 47).func_228303_a_(-1.0F, -1.0F, -1.0F, 14.0F, 1.0F, 6.0F, 0.0F, false);
		...
		finR.setTextureOffset(47, 47).func_228303_a_(-13.0F, -1.0F, -1.0F, 14.0F, 1.0F, 6.0F, 0.0F, true);
		...
		topfin.setTextureOffset(0, 0).func_228303_a_(-1.0F, -13.0F, -2.0F, 2.0F, 14.0F, 7.0F, 0.0F, false);

		tail1 = new AdvancedModelBox(this);
		tail1.setRotationPoint(0.0F, -0.3F, 11.75F);
		main_body.addChild(tail1);
		tail1.setTextureOffset(0, 36).func_228303_a_(-4.0F, -2.5F, -0.75F, 8.0F, 8.0F, 15.0F, 0.0F, false);
		...
		tail_finL.setTextureOffset(64, 55).func_228303_a_(0.0F, -1.0F, 0.0F, 8.0F, 1.0F, 4.0F, 0.0F, false);
		...
		tail_finR.setTextureOffset(64, 55).func_228303_a_(-8.0F, -1.0F, 0.0F, 8.0F, 1.0F, 4.0F, 0.0F, true);
		...
		topfintail.setTextureOffset(0, 36).func_228303_a_(-0.5F, -4.0237F, -1.7836F, 1.0F, 5.0F, 4.0F, 0.0F, false);

		tail2 = new AdvancedModelBox(this);
		tail2.setRotationPoint(0.0F, 0.3F, 14.75F);
		tail1.addChild(tail2);
		tail2.setTextureOffset(46, 0).func_228303_a_(-2.5F, -2.0F, -0.5F, 5.0F, 6.0F, 14.0F, 0.0F, false);
		...
		tailbottomend.setTextureOffset(17, 60).func_228303_a_(0.0F, -11.5F, -2.5F, 1.0F, 14.0F, 6.0F, 0.0F, false);
		...
		tailtopend.setTextureOffset(0, 60).func_228303_a_(-1.0F, -16.5F, -1.5F, 2.0F, 19.0F, 6.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityHammerheadShark) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
