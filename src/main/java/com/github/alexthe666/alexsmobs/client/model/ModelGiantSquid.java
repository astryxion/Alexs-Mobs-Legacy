...
public class ModelGiantSquid extends AdvancedEntityModel<EntityGiantSquid> {
    ...
    public ModelGiantSquid() {
        ...
        root.addChild(head);
        head.setTextureOffset(43, 35).func_228303_a_(-5.0F, -9.0F, -5.0F, 10.0F, 14.0F, 10.0F, 0.0F, false);

        beak = new AdvancedModelBox(this, "beak");
        beak.setRotationPoint(0.0F, 5.0F, 0.0F);
        head.addChild(beak);
        beak.setTextureOffset(41, 0).func_228303_a_(-1.5F, 0.0F, -2.0F, 3.0F, 2.0F, 4.0F, 0.0F, false);
        ...
        left_FrontTentacle.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
        ...
        left_FrontTentacleEnd.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
        ...
        left_FrontMidTentacle.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
        ...
        left_FrontMidTentacleEnd.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
        ...
        right_FrontMidTentacle.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, true);
        ...
        right_FrontMidTentacleEnd.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, true);
        ...
        left_BackMidTentacle.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
        ...
        left_BackMidTentacleEnd.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
        ...
        right_BackMidTentacle.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, true);
        ...
        right_BackMidTentacleEnd.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, true);
        ...
        left_BackTentacle.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
        ...
        left_BackTentacleEnd.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
        ...
        right_BackTentacle.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, true);
        ...
        right_BackTentacleEnd.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, true);
        ...
        right_FrontTentacle.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, true);
        ...
        right_tentacleEnd.setTextureOffset(18, 70).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, true);
        ...
        left_pupil.setTextureOffset(0, 0).func_228303_a_(0.0F, -2.5F, -2.5F, 0.0F, 5.0F, 5.0F, 0.0F, false);

        right_eye = new AdvancedModelBox(this, "right_eye");
        right_eye.setRotationPoint(-5.9F, 0.5F, 0.0F);
        head.addChild(right_eye);
        right_eye.setTextureOffset(53, 19).func_228303_a_(-1.5F, -3.5F, -3.5F, 3.0F, 7.0F, 7.0F, 0.0F, true);
        ...
        right_pupil.setTextureOffset(0, 0).func_228303_a_(0.0F, -2.5F, -2.5F, 0.0F, 5.0F, 5.0F, 0.0F, true);

        mantle = new AdvancedModelBox(this, "mantle");
        mantle.setRotationPoint(0.0F, -5.0F, 0.0F);
        head.addChild(mantle);
        mantle.setTextureOffset(0, 0).func_228303_a_(-7.0F, -31.0F, -6.0F, 14.0F, 32.0F, 12.0F, 0.0F, false);

        mantle_end = new AdvancedModelBox(this, "mantle_end");
        mantle_end.setRotationPoint(0.0F, -31.0F, 0.0F);
        mantle.addChild(mantle_end);
        mantle_end.setTextureOffset(53, 0).func_228303_a_(-4.0F, -7.0F, -4.0F, 8.0F, 10.0F, 8.0F, 0.0F, false);
        ...
        left_membrane.setTextureOffset(0, 45).func_228303_a_(0.0F, -12.0F, 0.0F, 17.0F, 24.0F, 0.0F, 0.0F, false);
        ...
        right_membrane.setTextureOffset(0, 45).func_228303_a_(-17.0F, -12.0F, 0.0F, 17.0F, 24.0F, 0.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        if (!(entityIn instanceof EntityGiantSquid)) return;
        setRotationAngles((EntityGiantSquid) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }

    public void setRotationAngles(EntityGiantSquid entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (look != null) {
            Vec3d vector3d = new Vec3d(look.posX, look.posY + look.getEyeHeight(), look.posZ);
            Vec3d vector3d1 = new Vec3d(entity.posX, entity.posY + entity.getEyeHeight(), entity.posZ);
            float dist = MathHelper.clamp((float) vector3d.subtract(vector3d1).lengthVector() * 0.2F, 0.4F, 1.0F);
            float eyeScale = 1.4F - dist;
            float maxEyeDist = 0.7F;
            double d0 = (vector3d.y - vector3d1.y);
            Vec3d vector3d2 = entity.getLook(0.0F);
            vector3d2 = new Vec3d(vector3d2.x, 0.0D, vector3d2.z);
            Vec3d vector3d3 = (new Vec3d(vector3d.x - vector3d1.x, 0.0D, vector3d.z - vector3d1.z)).normalize();
            double d1 = vector3d2.dotProduct(vector3d3);
            double eyeXz = MathHelper.sqrt((float) Math.abs(d1)) * -2F * (float) Math.signum(d1);
            this.left_pupil.setScale(eyeScale, eyeScale, eyeScale);
            this.left_pupil.rotationPointZ -= (float) MathHelper.clamp(-eyeXz, -maxEyeDist / eyeScale, maxEyeDist / eyeScale);
            this.left_pupil.rotationPointY += (float) MathHelper.clamp(-d0, -maxEyeDist / eyeScale, maxEyeDist / eyeScale);
            this.right_pupil.setScale(eyeScale, eyeScale, eyeScale);
            this.right_pupil.rotationPointZ += (float) MathHelper.clamp(eyeXz, -maxEyeDist / eyeScale, maxEyeDist / eyeScale);
            this.right_pupil.rotationPointY += (float) MathHelper.clamp(-d0, -maxEyeDist / eyeScale, maxEyeDist / eyeScale);
        }
    }
    ...
    private float getArmRot(EntityGiantSquid entity, int offset, float partialTick, boolean pitch) {
        float rotWrap = MathHelper.wrapDegrees(entity.getRingBuffer(offset, partialTick, pitch) - entity.getRingBuffer(0, partialTick, pitch));
        return (MathHelper.clamp(rotWrap, -50, 50) * 0.4F) * ((float) Math.PI / 180F);
    }
