...
public class ModelGorilla extends AdvancedEntityModel<EntityGorilla> {
    ...
    public ModelGorilla() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 23).func_228303_a_(-4.5F, -4.0F, -3.0F, 9.0F, 9.0F, 7.0F, 0.0F, false);

        chest = new AdvancedModelBox(this);
        chest.setRotationPoint(0.0F, 4.0F, -3.0F);
        body.addChild(chest);
        chest.setTextureOffset(0, 0).func_228303_a_(-6.5F, -8.0F, -11.0F, 13.0F, 11.0F, 11.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -8.0F, -11.0F);
        chest.addChild(head);
        head.setTextureOffset(22, 48).func_228303_a_(-3.0F, -5.0F, -4.0F, 6.0F, 7.0F, 7.0F, 0.0F, false);
        head.setTextureOffset(38, 0).func_228303_a_(-3.0F, -6.0F, -4.0F, 6.0F, 1.0F, 7.0F, 0.0F, false);
        head.setTextureOffset(0, 40).func_228303_a_(-3.0F, -8.0F, -5.0F, 6.0F, 4.0F, 8.0F, 0.0F, false);
        ...
        foreheadDK_r1.setTextureOffset(0, 56).func_228303_a_(0.0F, -6.0F, -4.0F, 0.0F, 6.0F, 10.0F, 0.0F, false);

        mouth = new AdvancedModelBox(this);
        mouth.setRotationPoint(0.0F, 0.0F, -1.0F);
        head.addChild(mouth);
        mouth.setTextureOffset(49, 9).func_228303_a_(-2.0F, -2.0F, -5.0F, 4.0F, 5.0F, 4.0F, 0.0F, false);

        leftArm = new AdvancedModelBox(this);
        leftArm.setRotationPoint(6.0F, -6.5F, -9.5F);
        chest.addChild(leftArm);
        leftArm.setTextureOffset(33, 23).func_228303_a_(-3.0F, -2.5F, -2.5F, 6.0F, 19.0F, 5.0F, 0.0F, false);

        rightArm = new AdvancedModelBox(this);
        rightArm.setRotationPoint(-6.0F, -6.5F, -9.5F);
        chest.addChild(rightArm);
        rightArm.setTextureOffset(33, 23).func_228303_a_(-3.0F, -2.5F, -2.5F, 6.0F, 19.0F, 5.0F, 0.0F, true);

        leftLeg = new AdvancedModelBox(this);
        leftLeg.setRotationPoint(3.0F, 4.5F, 2.5F);
        body.addChild(leftLeg);
        leftLeg.setTextureOffset(49, 48).func_228303_a_(-2.5F, 0.5F, -2.5F, 5.0F, 9.0F, 5.0F, 0.0F, false);

        rightLeg = new AdvancedModelBox(this);
        rightLeg.setRotationPoint(-3.0F, 4.5F, 2.5F);
        body.addChild(rightLeg);
        rightLeg.setTextureOffset(49, 48).func_228303_a_(-2.5F, 0.5F, -2.5F, 5.0F, 9.0F, 5.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityGorilla) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void setRotationAngles(EntityGorilla entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float rideProgress = entityIn.isRiding() && entityIn.isChild() ? 5F : 0;
