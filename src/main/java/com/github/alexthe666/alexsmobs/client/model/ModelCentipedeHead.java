...
public class ModelCentipedeHead extends AdvancedEntityModel<EntityCentipedeHead> {
	...
	public ModelCentipedeHead() {
		...
		bone.addChild(head);
		head.setTextureOffset(0, 11).func_228303_a_(-7.0F, -3.125F, -5.375F, 14.0F, 7.0F, 13.0F, 0.0F, false);

		head2 = new AdvancedModelBox(this);
		head2.setRotationPoint(0.0F, -2.125F, -6.375F);
		head.addChild(head2);
		head2.setTextureOffset(0, 11).func_228303_a_(-2.0F, -1.0F, -1.0F, 4.0F, 2.0F, 2.0F, 0.0F, false);
		...
		antenna_left_r1.setTextureOffset(0, 0).func_228303_a_(-1.0F, 0.0F, -1.0F, 23.0F, 0.0F, 10.0F, 0.0F, false);
		...
		antenna_right_r1.setTextureOffset(0, 0).func_228303_a_(-22.0F, 0.0F, -1.0F, 23.0F, 0.0F, 10.0F, 0.0F, true);

		fangs = new AdvancedModelBox(this);
		fangs.setRotationPoint(0.0F, 1.875F, -6.375F);
		head.addChild(fangs);
		fangs.setTextureOffset(0, 32).func_228303_a_(-7.0F, 0.0F, -5.0F, 14.0F, 0.0F, 6.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCentipedeHead) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
