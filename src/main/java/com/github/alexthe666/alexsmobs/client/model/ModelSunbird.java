...
public class ModelSunbird extends AdvancedEntityModel<EntitySunbird> {
    ...
    public ModelSunbird() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 32).func_228303_a_(-3.0F, -5.0F, -7.0F, 6.0F, 5.0F, 14.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, -5.0F, 7.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 0).func_228303_a_(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 20.0F, 0.0F, false);

        wingL1 = new AdvancedModelBox(this);
        wingL1.setRotationPoint(3.0F, -4.0F, -5.0F);
        body.addChild(wingL1);
        wingL1.setTextureOffset(37, 11).func_228303_a_(0.0F, -1.0F, -1.0F, 9.0F, 1.0F, 3.0F, 0.0F, false);
        wingL1.setTextureOffset(27, 32).func_228303_a_(0.0F, -0.5F, -2.0F, 13.0F, 0.0F, 10.0F, 0.0F, false);

        wingR2 = new AdvancedModelBox(this);
        wingR2.setRotationPoint(13.0F, -0.5F, 0.0F);
        wingL1.addChild(wingR2);
        wingR2.setTextureOffset(0, 21).func_228303_a_(0.0F, 0.0F, -2.0F, 16.0F, 0.0F, 10.0F, 0.0F, false);

        wingR1 = new AdvancedModelBox(this);
        wingR1.setRotationPoint(-3.0F, -4.0F, -5.0F);
        body.addChild(wingR1);
        wingR1.setTextureOffset(37, 11).func_228303_a_(-9.0F, -1.0F, -1.0F, 9.0F, 1.0F, 3.0F, 0.0F, true);
        wingR1.setTextureOffset(27, 32).func_228303_a_(-13.0F, -0.5F, -2.0F, 13.0F, 0.0F, 10.0F, 0.0F, true);

        wingR3 = new AdvancedModelBox(this);
        wingR3.setRotationPoint(-13.0F, -0.5F, 0.0F);
        wingR1.addChild(wingR3);
        wingR3.setTextureOffset(0, 21).func_228303_a_(-16.0F, 0.0F, -2.0F, 16.0F, 0.0F, 10.0F, 0.0F, true);

        legL = new AdvancedModelBox(this);
        legL.setRotationPoint(1.5F, 0.0F, 3.0F);
        body.addChild(legL);
        setRotationAngle(legL, 1.2654F, 0.0F, 0.0F);
        legL.setTextureOffset(0, 21).func_228303_a_(-0.5F, 0.0F, 0.0F, 1.0F, 5.0F, 1.0F, 0.0F, false);

        footL = new AdvancedModelBox(this);
        footL.setRotationPoint(0.0F, 5.0F, 0.5F);
        legL.addChild(footL);
        footL.setTextureOffset(6, 9).func_228303_a_(-1.5F, 0.0F, -1.5F, 3.0F, 2.0F, 2.0F, 0.0F, false);

        legR = new AdvancedModelBox(this);
        legR.setRotationPoint(-1.5F, 0.0F, 3.0F);
        body.addChild(legR);
        setRotationAngle(legR, 1.2654F, 0.0F, 0.0F);
        legR.setTextureOffset(0, 21).func_228303_a_(-0.5F, 0.0F, 0.0F, 1.0F, 5.0F, 1.0F, 0.0F, true);

        footR = new AdvancedModelBox(this);
        footR.setRotationPoint(0.0F, 5.0F, 0.5F);
        legR.addChild(footR);
        footR.setTextureOffset(6, 9).func_228303_a_(-1.5F, 0.0F, -1.5F, 3.0F, 2.0F, 2.0F, 0.0F, true);

        neck = new AdvancedModelBox(this);
        neck.setRotationPoint(0.0F, -2.55F, -6.95F);
        body.addChild(neck);
        neck.setTextureOffset(37, 0).func_228303_a_(-1.5F, -1.45F, -7.05F, 3.0F, 3.0F, 7.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, 0.05F, -7.05F);
        neck.addChild(head);
        head.setTextureOffset(0, 0).func_228303_a_(-2.0F, -2.0F, -4.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);

        crest = new AdvancedModelBox(this);
        crest.setRotationPoint(0.0F, -2.0F, -2.5F);
        head.addChild(crest);
        crest.setTextureOffset(0, 9).func_228303_a_(0.0F, -3.0F, -2.5F, 0.0F, 3.0F, 5.0F, 0.0F, false);

        beak = new AdvancedModelBox(this);
        beak.setRotationPoint(0.0F, 1.0F, -4.0F);
        head.addChild(beak);
        beak.setTextureOffset(0, 32).func_228303_a_(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntitySunbird) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
