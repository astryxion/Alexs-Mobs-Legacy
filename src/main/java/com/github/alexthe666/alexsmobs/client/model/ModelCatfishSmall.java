...
public class ModelCatfishSmall extends AdvancedEntityModel<EntityCatfish> {
	...
	public ModelCatfishSmall() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-4.0F, -3.0F, -8.0F, 8.0F, 6.0F, 14.0F, 0.0F, false);
		...
		left_barbel.setTextureOffset(0, 10).func_228303_a_(0.0F, 0.0F, 0.0F, 6.0F, 3.0F, 0.0F, 0.0F, false);
		...
		right_barbel.setTextureOffset(0, 10).func_228303_a_(-6.0F, 0.0F, 0.0F, 6.0F, 3.0F, 0.0F, 0.0F, true);
		...
		dorsal_fin.setTextureOffset(0, 21).func_228303_a_(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 5.0F, 0.0F, false);
		...
		left_fin.setTextureOffset(19, 21).func_228303_a_(0.0F, 0.0F, -1.0F, 0.0F, 2.0F, 4.0F, 0.0F, false);
		...
		right_fin.setTextureOffset(19, 21).func_228303_a_(0.0F, 0.0F, -1.0F, 0.0F, 2.0F, 4.0F, 0.0F, true);

		tail = new AdvancedModelBox(this, "tail");
		tail.setRotationPoint(0.0F, 0.0F, 7.0F);
		body.addChild(tail);
		tail.setTextureOffset(0, 21).func_228303_a_(-2.0F, -3.0F, -1.0F, 4.0F, 5.0F, 10.0F, 0.0F, false);
		tail.setTextureOffset(0, 0).func_228303_a_(0.0F, -4.0F, 2.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);
		tail.setTextureOffset(0, 0).func_228303_a_(0.0F, 2.0F, -1.0F, 0.0F, 2.0F, 6.0F, 0.0F, false);

		tail_fin = new AdvancedModelBox(this, "tail_fin");
		tail_fin.setRotationPoint(0.0F, 2.0F, 9.0F);
		tail.addChild(tail_fin);
		tail_fin.setTextureOffset(19, 27).func_228303_a_(0.0F, -7.0F, -2.0F, 0.0F, 9.0F, 10.0F, 0.0F, false);
