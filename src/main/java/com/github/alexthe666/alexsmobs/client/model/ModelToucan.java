...
public class ModelToucan extends AdvancedEntityModel<EntityToucan> {
    ...
    public ModelToucan() {
        ...
        body.setTextureOffset(0, 0).func_228303_a_(-2.0F, -3.0F, -5.0F, 4.0F, 4.0F, 7.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -2.0F, 2.0F);
        body.addChild(tail);
        setRotationAngle(tail, 0.3927F, 0.0F, 0.0F);
        tail.setTextureOffset(18, 7).func_228303_a_(-1.5F, -1.0F, 0.0F, 3.0F, 2.0F, 5.0F, 0.0F, false);
        ...
        left_wing.setTextureOffset(11, 16).func_228303_a_(0.0F, -1.0F, -1.0F, 1.0F, 4.0F, 6.0F, 0.0F, false);
        ...
        left_wingtip.setTextureOffset(20, 21).func_228303_a_(0.0F, -1.0F, -1.0F, 0.0F, 3.0F, 6.0F, 0.0F, false);
        ...
        right_wing.setTextureOffset(11, 16).func_228303_a_(-1.0F, -1.0F, -1.0F, 1.0F, 4.0F, 6.0F, 0.0F, true);
        ...
        right_wingtip.setTextureOffset(20, 21).func_228303_a_(0.0F, -1.0F, -1.0F, 0.0F, 3.0F, 6.0F, 0.0F, true);
        ...
        left_leg.setTextureOffset(0, 0).func_228303_a_(-0.5F, 0.0F, -2.0F, 1.0F, 3.0F, 2.0F, 0.0F, false);
        ...
        right_leg.setTextureOffset(0, 0).func_228303_a_(-0.5F, 0.0F, -2.0F, 1.0F, 3.0F, 2.0F, 0.0F, true);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -2.0F, -4.0F);
        body.addChild(head);
        setRotationAngle(head, 0.48F, 0.0F, 0.0F);
        head.setTextureOffset(0, 24).func_228303_a_(-1.5F, -4.0F, -2.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);

        beak = new AdvancedModelBox(this, "beak");
        beak.setRotationPoint(0.0F, -4.0F, -1.8F);
        head.addChild(beak);
        beak.setTextureOffset(0, 12).func_228303_a_(-1.0F, 0.0F, -6.0F, 2.0F, 3.0F, 6F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        setRotationAngles((EntityToucan) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }

    public void setRotationAngles(EntityToucan entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
