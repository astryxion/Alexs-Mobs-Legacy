...
public class ModelMantisShrimp extends AdvancedEntityModel<EntityMantisShrimp> {
	...
	public ModelMantisShrimp() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-6.0F, -2.0F, 0.0F, 12.0F, 10.0F, 25.0F, 0.0F, false);

		tail = new AdvancedModelBox(this);
		tail.setRotationPoint(0.0F, 0.0F, 21.0F);
		body.addChild(tail);
		setRotationAngle(tail, -0.2182F, 0.0F, 0.0F);
		tail.setTextureOffset(50, 0).func_228303_a_(-7.0F, 0.0F, 0.0F, 14.0F, 9.0F, 9.0F, 0.0F, false);

		legs_front = new AdvancedModelBox(this);
		legs_front.setRotationPoint(0.0F, 5.0F, -7.0F);
		body.addChild(legs_front);
		legs_front.setTextureOffset(0, 61).func_228303_a_(-5.0F, 0.0F, 0.0F, 10.0F, 9.0F, 8.0F, 0.0F, false);

		legs_back = new AdvancedModelBox(this);
		legs_back.setRotationPoint(0.0F, 8.0F, 1.0F);
		body.addChild(legs_back);
		legs_back.setTextureOffset(0, 36).func_228303_a_(-5.0F, 0.0F, 0.0F, 10.0F, 6.0F, 18.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, 4.0F, 2.0F);
		body.addChild(head);
		setRotationAngle(head, 0.3491F, 0.0F, 0.0F);
		head.setTextureOffset(49, 53).func_228303_a_(-6.0F, -14.0F, -8.0F, 12.0F, 14.0F, 8.0F, 0.1F, false);
		...
		flapper_left.setTextureOffset(50, 19).func_228303_a_(0.0F, 0.0F, 0.0F, 14.0F, 5.0F, 0.0F, 0.0F, false);
		...
		flapper_right.setTextureOffset(50, 19).func_228303_a_(-14.0F, 0.0F, 0.0F, 14.0F, 5.0F, 0.0F, 0.0F, true);

		eye_left = new AdvancedModelBox(this);
		eye_left.setRotationPoint(3.0F, -14.0F, -4.0F);
		head.addChild(eye_left);
		eye_left.setTextureOffset(0, 15).func_228303_a_(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);

		eye_right = new AdvancedModelBox(this);
		eye_right.setRotationPoint(-3.0F, -14.0F, -4.0F);
		head.addChild(eye_right);
		eye_right.setTextureOffset(0, 15).func_228303_a_(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, true);

		arm_left = new AdvancedModelBox(this);
		arm_left.setRotationPoint(4.0F, -1.0F, -8.0F);
		head.addChild(arm_left);
		arm_left.setTextureOffset(0, 36).func_228303_a_(-2.5F, -9.0F, -2.0F, 5.0F, 10.0F, 3.0F, 0.0F, false);

		fist_left = new AdvancedModelBox(this);
		fist_left.setRotationPoint(-1.0F, -7.0F, -1.0F);
		arm_left.addChild(fist_left);
		fist_left.setTextureOffset(0, 0).func_228303_a_(-1.0F, -1.0F, -4.0F, 4.0F, 10.0F, 4.0F, 0.0F, false);

		arm_right = new AdvancedModelBox(this);
		arm_right.setRotationPoint(-4.0F, -1.0F, -8.0F);
		head.addChild(arm_right);
		arm_right.setTextureOffset(0, 36).func_228303_a_(-2.5F, -9.0F, -2.0F, 5.0F, 10.0F, 3.0F, 0.0F, true);

		fist_right = new AdvancedModelBox(this);
		fist_right.setRotationPoint(1.0F, -7.0F, -1.0F);
		arm_right.addChild(fist_right);
		fist_right.setTextureOffset(0, 0).func_228303_a_(-3.0F, -1.0F, -4.0F, 4.0F, 10.0F, 4.0F, 0.0F, true);
		...
		whisker_left.setTextureOffset(39, 39).func_228303_a_(0.0F, 0.0F, -13.0F, 8.0F, 0.0F, 13.0F, 0.0F, false);
		...
		whisker_right.setTextureOffset(39, 39).func_228303_a_(-8.0F, 0.0F, -13.0F, 8.0F, 0.0F, 13.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityMantisShrimp) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
