...
public class ModelStraddleboard extends AdvancedEntityModel<EntityStraddleboard> {
	...
	public ModelStraddleboard() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-6.0F, -2.0F, -10.0F, 12.0F, 2.0F, 26.0F, 0.0F, false);
		...
		hair_left.setTextureOffset(0, 29).func_228303_a_(0.0F, -10.0F, -2.0F, 0.0F, 10.0F, 24.0F, 0.0F, false);
		...
		hair_right.setTextureOffset(0, 29).func_228303_a_(0.0F, -10.0F, -2.0F, 0.0F, 10.0F, 24.0F, 0.0F, true);

		spikes = new AdvancedModelBox(this);
		spikes.setRotationPoint(0.0F, -1.5F, 13.5F);
		body.addChild(spikes);
		spikes.setTextureOffset(25, 29).func_228303_a_(-4.0F, -5.5F, -3.5F, 8.0F, 11.0F, 7.0F, 0.0F, false);

		front = new AdvancedModelBox(this);
		front.setRotationPoint(0.0F, 0.0F, -10.0F);
		body.addChild(front);
		setRotationAngle(front, -0.1309F, 0.0F, 0.0F);
		front.setTextureOffset(48, 40).func_228303_a_(-5.0F, -2.0F, -8.0F, 10.0F, 2.0F, 8.0F, 0.0F, false);

		spikes_front = new AdvancedModelBox(this);
		spikes_front.setRotationPoint(0.0F, -4.0F, -3.5F);
		front.addChild(spikes_front);
		spikes_front.setTextureOffset(0, 0).func_228303_a_(-2.0F, -2.0F, -2.5F, 4.0F, 4.0F, 5.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityStraddleboard) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void setRotationAngles(EntityStraddleboard entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.animateBoard(entity, ageInTicks);
	}
