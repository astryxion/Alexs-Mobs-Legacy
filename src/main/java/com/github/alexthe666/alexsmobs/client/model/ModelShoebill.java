...
public class ModelShoebill extends AdvancedEntityModel<EntityShoebill> {
    ...
    public ModelShoebill() {
        ...
        body.setTextureOffset(0, 15).func_228303_a_(-2.5F, -5.0F, -2.0F, 5.0F, 10.0F, 5.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, 5.0F, 2.5F);
        body.addChild(tail);
        setRotationAngle(tail, -0.3054F, 0.0F, 0.0F);
        tail.setTextureOffset(0, 31).func_228303_a_(-2.0F, 0.0F, -3.0F, 4.0F, 5.0F, 3.0F, 0.0F, false);
        ...
        wing_left.setTextureOffset(21, 21).func_228303_a_(0.0F, 0.0F, -4.0F, 1.0F, 12.0F, 6.0F, 0.0F, false);
        ...
        wing_right.setTextureOffset(21, 21).func_228303_a_(-1.0F, 0.0F, -4.0F, 1.0F, 12.0F, 6.0F, 0.0F, true);
        ...
        leg_left.setTextureOffset(0, 0).func_228303_a_(-2.0F, -3.0F, -11.0F, 3.0F, 3.0F, 11.0F, 0.0F, false);
        ...
        leg_right.setTextureOffset(0, 0).func_228303_a_(-1.0F, -3.0F, -11.0F, 3.0F, 3.0F, 11.0F, 0.0F, true);

        neck = new AdvancedModelBox(this);
        neck.setRotationPoint(0.0F, -4.8F, 1.0F);
        body.addChild(neck);
        setRotationAngle(neck, -0.7418F, 0.0F, 0.0F);
        neck.setTextureOffset(35, 0).func_228303_a_(-1.5F, -4.0F, -1.5F, 3.0F, 5.0F, 3.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -3.8F, -0.3F);
        neck.addChild(head);
        head.setTextureOffset(25, 11).func_228303_a_(-2.0F, -3.0F, -2.0F, 4.0F, 3.0F, 4.0F, 0.0F, false);

        crest = new AdvancedModelBox(this);
        crest.setRotationPoint(0.0F, -2.0F, 2.0F);
        head.addChild(crest);
        crest.setTextureOffset(0, 0).func_228303_a_(0.0F, -2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 0.0F, false);

        beak = new AdvancedModelBox(this);
        beak.setRotationPoint(0.0F, -2.9F, -2.0F);
        head.addChild(beak);
        setRotationAngle(beak, 0.3491F, 0.0F, 0.0F);
        beak.setTextureOffset(18, 0).func_228303_a_(-1.5F, 0.0F, -5.0F, 3.0F, 2.0F, 5.0F, 0.0F, false);

        jaw = new AdvancedModelBox(this);
        jaw.setRotationPoint(0.0F, 2.0F, 0.0F);
        beak.addChild(jaw);
        setRotationAngle(jaw, -0.1745F, 0.0F, 0.0F);
        jaw.setTextureOffset(41, 36).func_228303_a_(-1.5F, 0.0F, -5.0F, 3.0F, 1.0F, 5.0F, -0.1F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityShoebill) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
