...
public class ModelLobster extends AdvancedEntityModel<EntityLobster> {
	...
	public ModelLobster() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 11).func_228303_a_(-2.0F, -1.4F, -7.0F, 4.0F, 2.0F, 7.0F, 0.0F, false);
		...
		antenna_left.setTextureOffset(18, 18).func_228303_a_(0.0F, -0.9F, -5.0F, 0.0F, 1.0F, 5.0F, 0.0F, false);
		...
		antenna_right.setTextureOffset(18, 20).func_228303_a_(0.0F, -0.9F, -5.0F, 0.0F, 1.0F, 5.0F, 0.0F, true);
		...
		arm_left.setTextureOffset(15, 5).func_228303_a_(0.0F, 0.0F, -0.5F, 4.0F, 0.0F, 1.0F, 0.0F, false);
		...
		hand_left.setTextureOffset(0, 21).func_228303_a_(0.0F, -1.0F, -1.9F, 3.0F, 1.0F, 2.0F, 0.0F, false);
		...
		arm_right.setTextureOffset(15, 6).func_228303_a_(-4.0F, 0.0F, -0.5F, 4.0F, 0.0F, 1.0F, 0.0F, true);
		...
		hand_right.setTextureOffset(0, 25).func_228303_a_(-3.0F, -1.0F, -1.9F, 3.0F, 1.0F, 2.0F, 0.0F, true);

		tail = new AdvancedModelBox(this);
		tail.setRotationPoint(0.0F, -0.4F, 0.0F);
		body.addChild(tail);
		tail.setTextureOffset(0, 0).func_228303_a_(-1.5F, -1.0F, 0.0F, 3.0F, 2.0F, 8.0F, 0.0F, false);

		tail2 = new AdvancedModelBox(this);
		tail2.setRotationPoint(0.0F, 0.0F, 6.0F);
		tail.addChild(tail2);
		tail2.setTextureOffset(15, 0).func_228303_a_(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 4.0F, 0.0F, false);
		...
		legs_left.setTextureOffset(16, 11).func_228303_a_(0.0F, 0.0F, -3.55F, 3.0F, 0.0F, 5.0F, 0.0F, false);
		...
		legs_right.setTextureOffset(25, 11).func_228303_a_(-3.0F, 0.0F, -3.55F, 3.0F, 0.0F, 5.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityLobster) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
