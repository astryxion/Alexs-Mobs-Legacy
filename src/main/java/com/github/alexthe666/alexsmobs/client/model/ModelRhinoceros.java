...
public class ModelRhinoceros extends AdvancedEntityModel<EntityRhinoceros> {
    ...
    public ModelRhinoceros() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 44).func_228303_a_(-9.0F, -10.0F, -6.0F, 18.0F, 20.0F, 21.0F, 0.0F, false);

        leftLeg = new AdvancedModelBox(this);
        leftLeg.setRotationPoint(6.0F, 9.0F, 12.0F);
        body.addChild(leftLeg);
        leftLeg.setTextureOffset(70, 77).func_228303_a_(-4.0F, -1.0F, -4.0F, 8.0F, 11.0F, 9.0F, 0.0F, false);

        rightLeg = new AdvancedModelBox(this);
        rightLeg.setRotationPoint(-6.0F, 9.0F, 12.0F);
        body.addChild(rightLeg);
        rightLeg.setTextureOffset(70, 77).func_228303_a_(-4.0F, -1.0F, -4.0F, 8.0F, 11.0F, 9.0F, 0.0F, true);

        chest = new AdvancedModelBox(this);
        chest.setRotationPoint(0.0F, -4.0F, -10.0F);
        body.addChild(chest);
        chest.setTextureOffset(0, 0).func_228303_a_(-11.0F, -10.0F, -14.0F, 22.0F, 23.0F, 20.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, 3.0F, -14.0F);
        chest.addChild(head);
        setRotationAngle(head, 0.3927F, 0.0F, 0.0F);
        head.setTextureOffset(76, 35).func_228303_a_(-6.0F, -6.0F, -8.0F, 12.0F, 14.0F, 9.0F, 0.0F, false);
        head.setTextureOffset(65, 0).func_228303_a_(-4.0F, 0.0F, -18.0F, 8.0F, 8.0F, 10.0F, 0.0F, false);

        horns = new AdvancedModelBox(this);
        horns.setRotationPoint(0.0F, 0, 0.0F);
        head.addChild(horns);
        horns.setTextureOffset(0, 0).func_228303_a_(-2.0F, -12.0F, -18.0F, 4.0F, 12.0F, 5.0F, 0.0F, false);
        horns.setTextureOffset(0, 44).func_228303_a_(-2.0F, -4.0F, -13.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
        ...
        leftEar.setTextureOffset(0, 53).func_228303_a_(-1.0F, -5.0F, 0.0F, 3.0F, 6.0F, 1.0F, 0.0F, false);
        ...
        rightEar.setTextureOffset(0, 53).func_228303_a_(-2.0F, -5.0F, 0.0F, 3.0F, 6.0F, 1.0F, 0.0F, true);

        leftArm = new AdvancedModelBox(this);
        leftArm.setRotationPoint(7.3F, 11.0F, -8.0F);
        chest.addChild(leftArm);
        leftArm.setTextureOffset(79, 59).func_228303_a_(-4.0F, 2.0F, -4.0F, 7.0F, 10.0F, 7.0F, 0.0F, false);

        rightArm = new AdvancedModelBox(this);
        rightArm.setRotationPoint(-7.3F, 11.0F, -8.0F);
        chest.addChild(rightArm);
        rightArm.setTextureOffset(79, 59).func_228303_a_(-3.0F, 2.0F, -4.0F, 7.0F, 10.0F, 7.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityRhinoceros) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }

    public void setRotationAngles(EntityRhinoceros entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetToDefaultPose();
