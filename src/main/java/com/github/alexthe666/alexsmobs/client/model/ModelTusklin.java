...
public class ModelTusklin extends AdvancedEntityModel<EntityTusklin> {
    ...
    public ModelTusklin() {
        ...
        root.addChild(body);
        body.setTextureOffset(52, 56).func_228303_a_(-8.0F, -7.0F, 0.0F, 16.0F, 15.0F, 15.0F, 0.0F, false);

        leg_left = new AdvancedModelBox(this, "leg_left");
        leg_left.setRotationPoint(6.0F, 8.0F, 13.0F);
        body.addChild(leg_left);
        leg_left.setTextureOffset(58, 0).func_228303_a_(-3.0F, -1.0F, -3.0F, 6.0F, 11.0F, 7.0F, 0.0F, false);

        leg_right = new AdvancedModelBox(this, "leg_right");
        leg_right.setRotationPoint(-6.0F, 8.0F, 13.0F);
        body.addChild(leg_right);
        leg_right.setTextureOffset(58, 0).func_228303_a_(-3.0F, -1.0F, -3.0F, 6.0F, 11.0F, 7.0F, 0.0F, true);

        torso = new AdvancedModelBox(this, "torso");
        torso.setRotationPoint(0.0F, 0.0F, -1.0F);
        body.addChild(torso);
        torso.setTextureOffset(0, 0).func_228303_a_(-9.0F, -11.0F, -20.0F, 18.0F, 20.0F, 21.0F, 0.0F, false);
        torso.setTextureOffset(0, 0).func_228303_a_(0.0F, -16.0F, -20.0F, 0.0F, 5.0F, 10.0F, 0.0F, false);

        arm_left = new AdvancedModelBox(this, "arm_left");
        arm_left.setRotationPoint(5.5F, 10.0F, -14.0F);
        torso.addChild(arm_left);
        arm_left.setTextureOffset(0, 71).func_228303_a_(-3.0F, -1.0F, -3.0F, 6.0F, 9.0F, 6.0F, 0.0F, false);

        arm_right = new AdvancedModelBox(this, "arm_right");
        arm_right.setRotationPoint(-5.5F, 10.0F, -14.0F);
        torso.addChild(arm_right);
        arm_right.setTextureOffset(0, 71).func_228303_a_(-3.0F, -1.0F, -3.0F, 6.0F, 9.0F, 6.0F, 0.0F, true);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -5.0F, -22.0F);
        torso.addChild(head);
        setRotationAngle(head, 0.5236F, 0.0F, 0.0F);
        head.setTextureOffset(0, 42).func_228303_a_(-7.0F, -3.0F, -17.0F, 14.0F, 9.0F, 19.0F, 0.0F, false);
        head.setTextureOffset(52, 50).func_228303_a_(0.0F, 6.0F, -16.0F, 0.0F, 3.0F, 7.0F, 0.0F, false);
        head.setTextureOffset(0, 42).func_228303_a_(0.0F, -10.0F, -5.0F, 0.0F, 7.0F, 7.0F, 0.0F, false);

        tusk_left = new AdvancedModelBox(this, "tusk_left");
        tusk_left.setRotationPoint(8.0F, 2.0F, -13.5F);
        head.addChild(tusk_left);
        tusk_left.setTextureOffset(48, 42).func_228303_a_(-1.0F, -11.0F, -1.5F, 2.0F, 11.0F, 3.0F, 0.0F, false);
        tusk_left.setTextureOffset(59, 42).func_228303_a_(-1.0F, -11.0F, 1.5F, 2.0F, 3.0F, 4.0F, 0.0F, false);

        tusk_right = new AdvancedModelBox(this, "tusk_right");
        tusk_right.setRotationPoint(-8.0F, 2.0F, -13.5F);
        head.addChild(tusk_right);
        tusk_right.setTextureOffset(48, 42).func_228303_a_(-1.0F, -11.0F, -1.5F, 2.0F, 11.0F, 3.0F, 0.0F, true);
        tusk_right.setTextureOffset(59, 42).func_228303_a_(-1.0F, -11.0F, 1.5F, 2.0F, 3.0F, 4.0F, 0.0F, true);
        ...
        earLeft_r1.setTextureOffset(68, 46).func_228303_a_(-1.0F, -1.0F, -3.0F, 1.0F, 5.0F, 4.0F, 0.0F, false);
        ...
        earLeft_r2.setTextureOffset(68, 46).func_228303_a_(0.0F, -1.0F, -3.0F, 1.0F, 5.0F, 4.0F, 0.0F, true);
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        EntityTusklin entity = (EntityTusklin) entityIn;
        if (entity.isChild()) {
            float f = 1.6F;
            float f1 = 2.2F;
            float f2 = 1.4F;
            ...
            GlStateManager.translate(0.0D, 1.6D, 0.125D);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityTusklin) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }

    public void setRotationAngles(EntityTusklin entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
