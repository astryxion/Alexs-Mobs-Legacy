...
public class ModelMimicOctopus extends AdvancedEntityModel<EntityMimicOctopus> {
    ...
    public ModelMimicOctopus() {
        ...
        root.addChild(head);
        head.setTextureOffset(18, 23).func_228303_a_(-2.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
        ...
        armstart4_left.setTextureOffset(41, 30).func_228303_a_(-1.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        armstart4_left.setTextureOffset(30, 0).func_228303_a_(-1.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, false);
        ...
        armmid4_left.setTextureOffset(0, 23).func_228303_a_(0.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        armmid4_left.setTextureOffset(25, 10).func_228303_a_(0.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, false);

        armend4_left = new AdvancedModelBox(this);
        armend4_left.setRotationPoint(1.0F, 6.0F, -0.5F);
        armmid4_left.addChild(armend4_left);
        armend4_left.setTextureOffset(0, 14).func_228303_a_(-1.0F, 0.0F, 0.0F, 1.0F, 6.0F, 1.0F, 0.0F, false);
        armend4_left.setTextureOffset(39, 0).func_228303_a_(-1.0F, 0.0F, -1.0F, 0.0F, 7.0F, 3.0F, 0.0F, false);
        ...
        armstart3_left.setTextureOffset(7, 48).func_228303_a_(-1.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        armstart3_left.setTextureOffset(9, 37).func_228303_a_(-1.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, false);

        armmid3_left = new AdvancedModelBox(this);
        armmid3_left.setRotationPoint(-1.0F, 6.0F, 0.0F);
        armstart3_left.addChild(armmid3_left);
        armmid3_left.setTextureOffset(0, 48).func_228303_a_(0.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        armmid3_left.setTextureOffset(0, 37).func_228303_a_(0.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, false);

        armend3_left = new AdvancedModelBox(this);
        armend3_left.setRotationPoint(1.0F, 6.0F, -0.5F);
        armmid3_left.addChild(armend3_left);
        armend3_left.setTextureOffset(37, 46).func_228303_a_(-1.0F, 0.0F, 0.0F, 1.0F, 6.0F, 1.0F, 0.0F, false);
        armend3_left.setTextureOffset(18, 43).func_228303_a_(-1.0F, 0.0F, -1.0F, 0.0F, 7.0F, 3.0F, 0.0F, false);
        ...
        armstart2_left.setTextureOffset(43, 44).func_228303_a_(-1.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        armstart2_left.setTextureOffset(34, 11).func_228303_a_(-1.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, false);

        armmid2_left = new AdvancedModelBox(this);
        armmid2_left.setRotationPoint(-1.0F, 6.0F, 0.0F);
        armstart2_left.addChild(armmid2_left);
        armmid2_left.setTextureOffset(30, 44).func_228303_a_(0.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        armmid2_left.setTextureOffset(31, 28).func_228303_a_(0.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, false);

        armend2_left = new AdvancedModelBox(this);
        armend2_left.setRotationPoint(1.0F, 6.0F, -0.5F);
        armmid2_left.addChild(armend2_left);
        armend2_left.setTextureOffset(21, 0).func_228303_a_(-1.0F, 0.0F, 0.0F, 1.0F, 6.0F, 1.0F, 0.0F, false);
        armend2_left.setTextureOffset(40, 19).func_228303_a_(-1.0F, 0.0F, -1.0F, 0.0F, 7.0F, 3.0F, 0.0F, false);
        ...
        armstart1_left.setTextureOffset(47, 19).func_228303_a_(-1.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        armstart1_left.setTextureOffset(36, 35).func_228303_a_(-1.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, false);

        armmid1_left = new AdvancedModelBox(this);
        armmid1_left.setRotationPoint(-1.0F, 6.0F, 0.0F);
        armstart1_left.addChild(armmid1_left);
        armmid1_left.setTextureOffset(47, 0).func_228303_a_(0.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        armmid1_left.setTextureOffset(23, 35).func_228303_a_(0.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, false);

        armend1_left = new AdvancedModelBox(this);
        armend1_left.setRotationPoint(1.0F, 6.0F, -0.5F);
        armmid1_left.addChild(armend1_left);
        armend1_left.setTextureOffset(25, 46).func_228303_a_(-1.0F, 0.0F, 0.0F, 1.0F, 6.0F, 1.0F, 0.0F, false);
        armend1_left.setTextureOffset(43, 8).func_228303_a_(-1.0F, 0.0F, -1.0F, 0.0F, 7.0F, 3.0F, 0.0F, false);
        ...
        armstart4_right.setTextureOffset(41, 30).func_228303_a_(0.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, true);
        armstart4_right.setTextureOffset(30, 0).func_228303_a_(1.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, true);
        ...
        armmid4_right.setTextureOffset(0, 23).func_228303_a_(-1.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, true);
        armmid4_right.setTextureOffset(25, 10).func_228303_a_(0.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, true);

        armend4_right = new AdvancedModelBox(this);
        armend4_right.setRotationPoint(-1.0F, 6.0F, -0.5F);
        armmid4_right.addChild(armend4_right);
        armend4_right.setTextureOffset(0, 14).func_228303_a_(0.0F, 0.0F, 0.0F, 1.0F, 6.0F, 1.0F, 0.0F, true);
        armend4_right.setTextureOffset(39, 0).func_228303_a_(1.0F, 0.0F, -1.0F, 0.0F, 7.0F, 3.0F, 0.0F, true);
        ...
        armstart3_right.setTextureOffset(7, 48).func_228303_a_(0.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, true);
        armstart3_right.setTextureOffset(9, 37).func_228303_a_(1.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, true);
        ...
        armmid3_right.setTextureOffset(0, 48).func_228303_a_(-1.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, true);
        armmid3_right.setTextureOffset(0, 37).func_228303_a_(0.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, true);

        armend3_right = new AdvancedModelBox(this);
        armend3_right.setRotationPoint(-1.0F, 6.0F, -0.5F);
        armmid3_right.addChild(armend3_right);
        armend3_right.setTextureOffset(37, 46).func_228303_a_(0.0F, 0.0F, 0.0F, 1.0F, 6.0F, 1.0F, 0.0F, true);
        armend3_right.setTextureOffset(18, 43).func_228303_a_(1.0F, 0.0F, -1.0F, 0.0F, 7.0F, 3.0F, 0.0F, true);
        ...
        armstart_right2.setTextureOffset(43, 44).func_228303_a_(0.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, true);
        armstart_right2.setTextureOffset(34, 11).func_228303_a_(1.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, true);
        ...
        armmid_right2.setTextureOffset(30, 44).func_228303_a_(-1.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, true);
        armmid_right2.setTextureOffset(31, 28).func_228303_a_(0.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, true);

        armend_right2 = new AdvancedModelBox(this);
        armend_right2.setRotationPoint(-1.0F, 6.0F, -0.5F);
        armmid_right2.addChild(armend_right2);
        armend_right2.setTextureOffset(21, 0).func_228303_a_(0.0F, 0.0F, 0.0F, 1.0F, 6.0F, 1.0F, 0.0F, true);
        armend_right2.setTextureOffset(40, 19).func_228303_a_(1.0F, 0.0F, -1.0F, 0.0F, 7.0F, 3.0F, 0.0F, true);
        ...
        armstart1_right.setTextureOffset(47, 19).func_228303_a_(0.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, true);
        armstart1_right.setTextureOffset(36, 35).func_228303_a_(1.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, true);
        ...
        armmid1_right.setTextureOffset(47, 0).func_228303_a_(-1.0F, 0.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, true);
        armmid1_right.setTextureOffset(23, 35).func_228303_a_(0.0F, 0.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, true);

        armend1_right = new AdvancedModelBox(this);
        armend1_right.setRotationPoint(-1.0F, 6.0F, -0.5F);
        armmid1_right.addChild(armend1_right);
        armend1_right.setTextureOffset(25, 46).func_228303_a_(0.0F, 0.0F, 0.0F, 1.0F, 6.0F, 1.0F, 0.0F, true);
        armend1_right.setTextureOffset(43, 8).func_228303_a_(1.0F, 0.0F, -1.0F, 0.0F, 7.0F, 3.0F, 0.0F, true);
        ...
        mantle.setTextureOffset(0, 0).func_228303_a_(-3.0F, -1.0F, 0.0F, 6.0F, 5.0F, 8.0F, 0.0F, false);
        mantle.setTextureOffset(0, 23).func_228303_a_(-2.0F, -3.0F, 1.0F, 4.0F, 4.0F, 9.0F, 0.0F, false);
        mantle.setTextureOffset(0, 14).func_228303_a_(-4.0F, 2.0F, 1.0F, 8.0F, 0.0F, 8.0F, 0.0F, false);

        eye_spike_left = new AdvancedModelBox(this);
        eye_spike_left.setRotationPoint(2.0F, -4.0F, -2.0F);
        head.addChild(eye_spike_left);
        eye_spike_left.setTextureOffset(0, 0).func_228303_a_(0.0F, -4.0F, -1.0F, 0.0F, 4.0F, 3.0F, 0.0F, false);

        eye_spike_right = new AdvancedModelBox(this);
        eye_spike_right.setRotationPoint(-2.0F, -4.0F, -2.0F);
        head.addChild(eye_spike_right);
        eye_spike_right.setTextureOffset(0, 0).func_228303_a_(0.0F, -4.0F, -1.0F, 0.0F, 4.0F, 3.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityMimicOctopus) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
