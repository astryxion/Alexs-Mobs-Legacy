...
public class ModelElephant extends AdvancedEntityModel<EntityElephant> {
    ...
    public ModelElephant(float scale) {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-10.0F, -20.0F, -17.0F, 20.0F, 23.0F, 33.0F, scale, false);
        ...
        storage_chest_left.setTextureOffset(32, 101).func_228303_a_(1.0F, -0.5F, -7.5F, 6.0F, 11.0F, 15.0F, scale, false);
        ...
        storage_chest_right.setTextureOffset(32, 101).func_228303_a_(-7.0F, -0.5F, -7.5F, 6.0F, 11.0F, 15.0F, scale, true);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, -10.0F, 16.0F);
        body.addChild(tail);
        setRotationAngle(tail, 0.0873F, 0.0F, 0.0F);
        tail.setTextureOffset(0, 85).func_228303_a_(-3.0F, 0.0F, 0.0F, 6.0F, 20.0F, 0.0F, scale, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -10.0F, -18.0F);
        body.addChild(head);
        head.setTextureOffset(0, 57).func_228303_a_(-7.0F, -9.0F, -10.0F, 14.0F, 16.0F, 11.0F, scale, false);
        ...
        trunk1.setTextureOffset(74, 0).func_228303_a_(-3.0F, -2.0F, -5.0F, 6.0F, 14.0F, 6.0F, scale, false);
        ...
        trunk2.setTextureOffset(84, 57).func_228303_a_(-3.0F, 0.0F, 0.0F, 5.0F, 15.0F, 5.0F, scale, false);
        ...
        ear_left.setTextureOffset(0, 0).func_228303_a_(0.0F, 0.0F, -0.5F, 14.0F, 18.0F, 1.0F, scale, false);
        ...
        ear_right.setTextureOffset(0, 0).func_228303_a_(-14.0F, 0.0F, -0.5F, 14.0F, 18.0F, 1.0F, scale, true);
        ...
        tusk_left.setTextureOffset(0, 20).func_228303_a_(-1.0F, 0.0F, -2.0F, 2.0F, 9.0F, 2.0F, scale, false);
        ...
        tusk_right.setTextureOffset(0, 20).func_228303_a_(-1.0F, 0.0F, -2.0F, 2.0F, 9.0F, 2.0F, scale, true);

        frontleg_left = new AdvancedModelBox(this);
        frontleg_left.setRotationPoint(8.0F, -0.5F, -12.0F);
        body.addChild(frontleg_left);
        frontleg_left.setTextureOffset(84, 84).func_228303_a_(-5.0F, -4.5F, -4.0F, 8.0F, 27.0F, 8.0F, scale, false);

        frontleg_right = new AdvancedModelBox(this);
        frontleg_right.setRotationPoint(-8.0F, -0.5F, -12.0F);
        body.addChild(frontleg_right);
        frontleg_right.setTextureOffset(84, 84).func_228303_a_(-3.0F, -4.5F, -4.0F, 8.0F, 27.0F, 8.0F, scale, true);

        backleg_left = new AdvancedModelBox(this);
        backleg_left.setRotationPoint(8.0F, -0.5F, 11.0F);
        body.addChild(backleg_left);
        backleg_left.setTextureOffset(51, 57).func_228303_a_(-5.0F, -5.5F, -4.0F, 8.0F, 28.0F, 8.0F, scale, false);

        backleg_right = new AdvancedModelBox(this);
        backleg_right.setRotationPoint(-8.0F, -0.5F, 11.0F);
        body.addChild(backleg_right);
        backleg_right.setTextureOffset(51, 57).func_228303_a_(-3.0F, -5.5F, -4.0F, 8.0F, 28.0F, 8.0F, scale, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityElephant) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
