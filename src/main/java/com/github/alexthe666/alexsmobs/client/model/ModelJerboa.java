...
public class ModelJerboa extends AdvancedEntityModel<EntityJerboa> {
    ...
    public ModelJerboa() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 19).func_228303_a_(-2.5F, -2.0F, -4.0F, 5.0F, 4.0F, 8.0F, 0.0F, false);
        ...
        leftEar.setTextureOffset(0, 0).func_228303_a_(-2.0F, -5.0F, 0.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        ...
        rightEar.setTextureOffset(0, 0).func_228303_a_(-2.0F, -5.0F, 0.0F, 4.0F, 5.0F, 0.0F, 0.0F, true);
        ...
        leftArm.setTextureOffset(0, 6).func_228303_a_(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, 0.0F, false);
        ...
        rightArm.setTextureOffset(0, 6).func_228303_a_(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 1.0F, 4.0F);
        body.addChild(tail);
        setRotationAngle(tail, -0.3491F, 0.0F, 0.0F);
        tail.setTextureOffset(0, 0).func_228303_a_(-1.5F, -6.0F, 0.0F, 3.0F, 6.0F, 12.0F, 0.0F, false);

        legs = new AdvancedModelBox(this, "legs");
        legs.setRotationPoint(0.0F, 1.9F, 2.8F);
        body.addChild(legs);
        setRotationAngle(legs, 0.5236F, 0.0F, 0.0F);
        legs.setTextureOffset(19, 0).func_228303_a_(-2.0F, 0.0F, -5.0F, 4.0F, 3.0F, 5.0F, 0.0F, false);

        feet = new AdvancedModelBox(this, "feet");
        feet.setRotationPoint(0.0F, 3.0F, -5.0F);
        legs.addChild(feet);
        setRotationAngle(feet, -0.5236F, 0.0F, 0.0F);
        feet.setTextureOffset(19, 9).func_228303_a_(-2.0F, 0.0F, -2.0F, 4.0F, 0.0F, 2.0F, 0.0F, false);
    ...
    public void setRotationAngles(EntityJerboa entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        setRotationAngles((EntityJerboa) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
