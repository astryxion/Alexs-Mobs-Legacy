...
public class ModelOrca extends AdvancedEntityModel<EntityOrca>  {
	...
	public ModelOrca() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-9.0F, -14.6667F, -16.9167F, 18.0F, 16.0F, 33.0F, 0.0F, false);
		...
		fintop.setTextureOffset(0, 0).func_228303_a_(-1.0F, -16.0F, -1.5F, 2.0F, 18.0F, 8.0F, 0.0F, false);
		...
		fin_left.setTextureOffset(0, 92).func_228303_a_(-7.5F, -1.5F, -3.0F, 12.0F, 2.0F, 17.0F, 0.0F, false);
		...
		fin_right.setTextureOffset(0, 92).func_228303_a_(-4.5F, -1.5F, -3.0F, 12.0F, 2.0F, 17.0F, 0.0F, true);

		tail1 = new AdvancedModelBox(this);
		tail1.setRotationPoint(0.0F, -5.9167F, 15.5833F);
		body.addChild(tail1);
		tail1.setTextureOffset(70, 0).func_228303_a_(-7.0F, -6.75F, 0.5F, 14.0F, 13.0F, 18.0F, 0.0F, false);

		tail2 = new AdvancedModelBox(this);
		tail2.setRotationPoint(0.0F, 0.25F, 16.5F);
		tail1.addChild(tail2);
		tail2.setTextureOffset(43, 97).func_228303_a_(-5.0F, -4.0F, 2.0F, 10.0F, 9.0F, 16.0F, 0.0F, false);

		tailend = new AdvancedModelBox(this);
		tailend.setRotationPoint(0.0F, 0.5F, 16.5F);
		tail2.addChild(tailend);
		tailend.setTextureOffset(0, 50).func_228303_a_(-16.0F, -1.0F, -2.5F, 32.0F, 2.0F, 13.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -5.6667F, -16.9167F);
		body.addChild(head);
		head.setTextureOffset(71, 71).func_228303_a_(-8.0F, -8.0F, -17.0F, 16.0F, 8.0F, 17.0F, 0.0F, false);
		head.setTextureOffset(96, 97).func_228303_a_(-7.0F, 0.0F, -15.0F, 14.0F, 1.0F, 15.0F, 0.0F, false);

		jaw = new AdvancedModelBox(this);
		jaw.setRotationPoint(0.0F, 1.0F, 0.0F);
		head.addChild(jaw);
		jaw.setTextureOffset(73, 50).func_228303_a_(-7.0F, -2.0F, -15.0F, 14.0F, 1.0F, 18.0F, 0.0F, false);
		jaw.setTextureOffset(0, 66).func_228303_a_(-8.0F, -1.0F, -16.0F, 16.0F, 6.0F, 19.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityOrca) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void setRotationAngles(EntityOrca entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (Math.sqrt(entityIn.motionX * entityIn.motionX + entityIn.motionZ * entityIn.motionZ) > 1.0E-7D) {
