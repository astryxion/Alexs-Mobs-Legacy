...
public class ModelSnowLeopard extends AdvancedEntityModel<EntitySnowLeopard> {
    ...
    public ModelSnowLeopard() {
        ...
        whisker_left.setTextureOffset(17, 17).func_228303_a_(0.0F, -3.0F, 0.0F, 2.0F, 4.0F, 0.0F, 0.0F, false);
        ...
        whisker_right.setTextureOffset(17, 17).func_228303_a_(-2.0F, -3.0F, 0.0F, 2.0F, 4.0F, 0.0F, 0.0F, true);

        ear_left = new AdvancedModelBox(this);
        ear_left.setRotationPoint(3.0F, -3.0F, -2.0F);
        head.addChild(ear_left);
        ear_left.setTextureOffset(41, 7).func_228303_a_(-1.0F, -2.0F, -2.0F, 1.0F, 2.0F, 3.0F, 0.0F, false);

        ear_right = new AdvancedModelBox(this);
        ear_right.setRotationPoint(-3.0F, -3.0F, -2.0F);
        head.addChild(ear_right);
        ear_right.setTextureOffset(41, 7).func_228303_a_(0.0F, -2.0F, -2.0F, 1.0F, 2.0F, 3.0F, 0.0F, true);

        snout = new AdvancedModelBox(this);
        snout.setRotationPoint(0.0F, 0.1F, -6.4F);
        head.addChild(snout);
        setRotationAngle(snout, 0.1745F, 0.0F, 0.0F);
        snout.setTextureOffset(41, 0).func_228303_a_(-2.0F, 0.0F, -2.2F, 4.0F, 3.0F, 3.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntitySnowLeopard) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
