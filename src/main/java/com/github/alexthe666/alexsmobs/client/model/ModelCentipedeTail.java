...
public class ModelCentipedeTail extends AdvancedEntityModel<EntityCentipedeTail> {
	...
	public ModelCentipedeTail() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-7.0F, -4.2F, -8.0F, 14.0F, 9.0F, 16.0F, 0.0F, false);
		...
		end_leg_L1.setTextureOffset(0, 26).func_228303_a_(-1.5F, -1.1F, -1.0F, 3.0F, 3.0F, 12.0F, 0.0F, false);
		...
		end_leg_L2.setTextureOffset(31, 31).func_228303_a_(-1.0F, -0.8F, -0.3F, 2.0F, 2.0F, 10.0F, 0.0F, false);
		...
		end_leg_L3.setTextureOffset(19, 26).func_228303_a_(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 9.0F, 0.0F, false);
		...
		end_leg_R1.setTextureOffset(0, 26).func_228303_a_(-1.5F, -1.1F, -1.0F, 3.0F, 3.0F, 12.0F, 0.0F, true);
		...
		end_leg_R2.setTextureOffset(31, 31).func_228303_a_(-1.0F, -0.8F, -0.3F, 2.0F, 2.0F, 10.0F, 0.0F, true);
		...
		end_leg_R3.setTextureOffset(19, 26).func_228303_a_(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 9.0F, 0.0F, true);
		...
		legfrontL1.setTextureOffset(44, 44).func_228303_a_(0.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, false);
		...
		legfrontL2.setTextureOffset(0, 42).func_228303_a_(0.0F, -1.0F, -1.0F, 9.0F, 2.0F, 2.0F, 0.0F, false);
		...
		legfrontR1.setTextureOffset(44, 44).func_228303_a_(-8.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, true);
		...
		legfrontR2.setTextureOffset(0, 42).func_228303_a_(-9.0F, -1.0F, -1.0F, 9.0F, 2.0F, 2.0F, 0.0F, true);
		...
		legbackL1.setTextureOffset(23, 44).func_228303_a_(0.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, false);
		...
		legbackL2.setTextureOffset(31, 26).func_228303_a_(0.0F, -1.0F, -1.0F, 9.0F, 2.0F, 2.0F, 0.0F, false);
		...
		legbackR1.setTextureOffset(23, 44).func_228303_a_(-8.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, true);
		...
		legbackR2.setTextureOffset(31, 26).func_228303_a_(-9.0F, -1.0F, -1.0F, 9.0F, 2.0F, 2.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCentipedeTail) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
