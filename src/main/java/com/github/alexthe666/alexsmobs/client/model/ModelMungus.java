...
public class ModelMungus extends AdvancedEntityModel<EntityMungus> {
    ...
    public ModelMungus(float f) {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-6.0F, -16.0F, -4.0F, 12.0F, 16.0F, 8.0F, f, false);

        hair = new AdvancedModelBox(this);
        hair.setRotationPoint(0.0F, -16.0F, 0.0F);
        body.addChild(hair);
        hair.setTextureOffset(33, 0).func_228303_a_(-5.0F, -5.0F, 0.0F, 10.0F, 5.0F, 0.0F, f, false);

        eye = new AdvancedModelBox(this);
        eye.setRotationPoint(0.0F, -11.0F, -4.1F);
        body.addChild(eye);
        eye.setTextureOffset(0, 0).func_228303_a_(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 1.0F, f, false);

        leg_left = new AdvancedModelBox(this);
        leg_left.setRotationPoint(3.0F, 0.0F, 0.0F);
        body.addChild(leg_left);
        leg_left.setTextureOffset(0, 39).func_228303_a_(-2.0F, 0.0F, -3.0F, 5.0F, 7.0F, 6.0F, f, false);

        leg_right = new AdvancedModelBox(this);
        leg_right.setRotationPoint(-3.0F, 0.0F, 0.0F);
        body.addChild(leg_right);
        leg_right.setTextureOffset(0, 25).func_228303_a_(-3.0F, 0.0F, -3.0F, 5.0F, 7.0F, 6.0F, f, false);

        nose = new AdvancedModelBox(this);
        nose.setRotationPoint(0.0F, -9.0F, -4.0F);
        body.addChild(nose);
        nose.setTextureOffset(35, 43).func_228303_a_(-1.0F, 0.0F, -2.0F, 2.0F, 5.0F, 2.0F, f, false);

        sack = new AdvancedModelBox(this);
        sack.setRotationPoint(0.0F, -7.0F, 4.0F);
        body.addChild(sack);
        sack.setTextureOffset(23, 25).func_228303_a_(-4.0F, -8.0F, 0.0F, 8.0F, 10.0F, 3.0F, f, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityMungus) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void setRotationAngles(EntityMungus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float swell = Math.min(entity.prevSwellProgress + (entity.swellProgress - entity.prevSwellProgress) * Minecraft.getMinecraft().getRenderPartialTicks(), 10F);
        ...
        if (targetPos == null) {
            ...
            if (look != null) {
                Vec3d vector3d = look.getPositionEyes(0.0F);
                Vec3d vector3d1 = entity.getPositionEyes(0.0F);
                ...
                Vec3d vector3d3 = (new Vec3d(vector3d1.x - vector3d.x, 0.0D, vector3d1.z - vector3d.z)).normalize().rotateYaw(((float) Math.PI / 2F));
                double d1 = vector3d2.dotProduct(vector3d3);
                this.eye.rotationPointX += MathHelper.sqrt(Math.abs((float) d1)) * 2.0F * (float) Math.signum((float) d1);
            }
        } else {
            Vec3d vector3d = new Vec3d(targetPos.getX() + 0.5D, targetPos.getY() + 0.5D, targetPos.getZ() + 0.5D);
            Vec3d vector3d1 = entity.getPositionEyes(0.0F);
            double d0 = vector3d.y - vector3d1.y;
            if (d0 > 0.0D) {
                this.eye.rotationPointY = -11.0F;
