...
public class ModelVoidWormShot extends AdvancedEntityModel<Entity> {
    ...
    public ModelVoidWormShot() {
        ...
        root.addChild(glass);
        glass.setTextureOffset(0, 21).func_228303_a_(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);

        cube = new AdvancedModelBox(this);
        cube.setRotationPoint(0.0F, -5.0F, 0.0F);
        root.addChild(cube);
        cube.setTextureOffset(0, 0).func_228303_a_(-5.0F, -5.0F, -5.0F, 10.0F, 10.0F, 10.0F, 0.0F, false);
