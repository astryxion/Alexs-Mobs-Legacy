...
public class ModelSombrero extends ModelBiped {
    ...
    public ModelSombrero(float modelSize) {
        ...
        this.sombrero.addBox(-4.0F, -11.0F, -4.0F, 8, 6, 8, 0.5F);
        this.sombrero.setTextureOffset(22, 73).addBox(-11.0F, -8.0F, -11.0F, 22, 3, 22, 0.5F);
        this.bipedHead.addChild(this.sombrero);
    }
