...
public class ModelBoneSerpentBody extends AdvancedEntityModel<EntityBoneSerpentPart> {
    ...
    public ModelBoneSerpentBody() {
        ...
        middle_section.setTextureOffset(2, 50).func_228303_a_(-2.0F, -9.25F, -8.0F, 4.0F, 2.0F, 16.0F, 0.0F, false);
        middle_section.setTextureOffset(0, 0).func_228303_a_(-9.0F, -7.25F, -8.0F, 18.0F, 15.0F, 16.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityBoneSerpentPart) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
