...
public class ModelTarantulaHawk extends AdvancedEntityModel<EntityTarantulaHawk> {
    ...
    public ModelTarantulaHawk() {
        ...
        root.addChild(body);
        body.setTextureOffset(33, 54).func_228303_a_(-3.0F, -3.0F, -5.0F, 6.0F, 6.0F, 10.0F, 0.0F, false);
        ...
        wing_left.setTextureOffset(0, 0).func_228303_a_(0.0F, 0.0F, -1.0F, 20.0F, 0.0F, 21.0F, 0.0F, false);
        ...
        wing_right.setTextureOffset(0, 0).func_228303_a_(-20.0F, 0.0F, -1.0F, 20.0F, 0.0F, 21.0F, 0.0F, true);
        ...
        legback_left.setTextureOffset(0, 41).func_228303_a_(0.0F, -3.0F, 0.0F, 21.0F, 15.0F, 0.0F, 0.0F, false);
        ...
        legback_right.setTextureOffset(0, 41).func_228303_a_(-21.0F, -3.0F, 0.0F, 21.0F, 15.0F, 0.0F, 0.0F, true);

        legmid_left = new AdvancedModelBox(this);
        legmid_left.setRotationPoint(2.0F, 3.0F, 0.0F);
        body.addChild(legmid_left);
        legmid_left.setTextureOffset(43, 38).func_228303_a_(0.0F, -3.0F, 0.0F, 19.0F, 15.0F, 0.0F, 0.0F, false);

        legmid_right = new AdvancedModelBox(this);
        legmid_right.setRotationPoint(-2.0F, 3.0F, 0.0F);
        body.addChild(legmid_right);
        legmid_right.setTextureOffset(43, 38).func_228303_a_(-19.0F, -3.0F, 0.0F, 19.0F, 15.0F, 0.0F, 0.0F, true);
        ...
        legfront_left.setTextureOffset(41, 22).func_228303_a_(0.0F, -3.0F, 0.0F, 19.0F, 15.0F, 0.0F, 0.0F, false);
        ...
        legfront_right.setTextureOffset(41, 22).func_228303_a_(-19.0F, -3.0F, 0.0F, 19.0F, 15.0F, 0.0F, 0.0F, true);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, 0.0F, -5.0F);
        body.addChild(head);
        head.setTextureOffset(0, 57).func_228303_a_(-4.0F, -2.0F, -4.0F, 8.0F, 7.0F, 4.0F, 0.0F, false);

        fang_left = new AdvancedModelBox(this);
        fang_left.setRotationPoint(1.0F, 4.5F, -3.3F);
        head.addChild(fang_left);
        fang_left.setTextureOffset(0, 22).func_228303_a_(-1.0F, -1.0F, -1.0F, 3.0F, 4.0F, 1.0F, 0.0F, false);

        fang_right = new AdvancedModelBox(this);
        fang_right.setRotationPoint(-1.0F, 4.5F, -3.3F);
        head.addChild(fang_right);
        fang_right.setTextureOffset(0, 22).func_228303_a_(-2.0F, -1.0F, -1.0F, 3.0F, 4.0F, 1.0F, 0.0F, true);
        ...
        antenna_left.setTextureOffset(0, 0).func_228303_a_(0.0F, 0.0F, -8.0F, 0.0F, 11.0F, 8.0F, 0.0F, false);
        ...
        antenna_right.setTextureOffset(0, 0).func_228303_a_(0.0F, 0.0F, -8.0F, 0.0F, 11.0F, 8.0F, 0.0F, true);

        abdomen = new AdvancedModelBox(this);
        abdomen.setRotationPoint(0.0F, -2.0F, 5.0F);
        body.addChild(abdomen);
        abdomen.setTextureOffset(0, 22).func_228303_a_(-4.0F, 0.0F, 0.0F, 8.0F, 6.0F, 12.0F, 0.0F, false);

        stinger = new AdvancedModelBox(this);
        stinger.setRotationPoint(0.0F, 3.0F, 12.0F);
        abdomen.addChild(stinger);
        stinger.setTextureOffset(9, 0).func_228303_a_(0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 5.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityTarantulaHawk) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
