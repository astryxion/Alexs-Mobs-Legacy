...
public class ModelCatfishLarge extends AdvancedEntityModel<EntityCatfish> {
    ...
    public ModelCatfishLarge() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-10.0F, -7.0F, -14.0F, 20.0F, 15.0F, 26.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(0, 0).func_228303_a_(0.0F, 0.0F, -2.0F, 5.0F, 0.0F, 8.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(0, 0).func_228303_a_(-5.0F, 0.0F, -2.0F, 5.0F, 0.0F, 8.0F, 0.0F, true);
        ...
        dorsal_fin.setTextureOffset(0, 0).func_228303_a_(0.0F, -7.0F, 0.0F, 0.0F, 7.0F, 8.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -2.0F, 13.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 41).func_228303_a_(-6.0F, -5.0F, -1.0F, 12.0F, 11.0F, 20.0F, 0.0F, false);
        tail.setTextureOffset(0, 56).func_228303_a_(0.0F, 6.0F, -1.0F, 0.0F, 4.0F, 16.0F, 0.0F, false);
        tail.setTextureOffset(16, 18).func_228303_a_(0.0F, -7.0F, 4.0F, 0.0F, 2.0F, 5.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this, "tail_fin");
        tail_fin.setRotationPoint(0.0F, 0.0F, 17.0F);
        tail.addChild(tail_fin);
        tail_fin.setTextureOffset(44, 18).func_228303_a_(0.0F, -10.0F, -5.0F, 0.0F, 17.0F, 23.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -5.0F, -15.0F);
        body.addChild(head);
        head.setTextureOffset(56, 64).func_228303_a_(-9.5F, -2.0F, -7.0F, 19.0F, 13.0F, 8.0F, 0.0F, false);
        ...
        left_BigWhisker.setTextureOffset(66, 0).func_228303_a_(0.0F, 0.0F, 0.0F, 15.0F, 8.0F, 0.0F, 0.0F, false);
        ...
        right_BigWhisker.setTextureOffset(66, 0).func_228303_a_(-15.0F, 0.0F, 0.0F, 15.0F, 8.0F, 0.0F, 0.0F, true);
        ...
        left_SmallWhisker.setTextureOffset(0, 15).func_228303_a_(0.0F, 0.0F, 0.0F, 7.0F, 6.0F, 0.0F, 0.0F, false);
        ...
        right_SmallWhisker.setTextureOffset(0, 15).func_228303_a_(-7.0F, 0.0F, 0.0F, 7.0F, 6.0F, 0.0F, 0.0F, true);
        this.updateDefaultPose();
    }

    public void setRotationAngles(EntityCatfish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        setRotationAngles((EntityCatfish) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
