...
public class LayerAnteaterBaby implements LayerRenderer<EntityAnteater> {
    ...
    @Override
    public void doRenderLayer(EntityAnteater roo, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
