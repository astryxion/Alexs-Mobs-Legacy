...
public class ModelFlyingFish extends AdvancedEntityModel<EntityFlyingFish> {
    ...
    public ModelFlyingFish() {
        ...
        root.addChild(body);
        body.setTextureOffset(11, 16).func_228303_a_(-1.5F, -2.0F, -4.0F, 3.0F, 4.0F, 8.0F, 0.0F, false);
        body.setTextureOffset(10, 6).func_228303_a_(-1.5F, -2.0F, -5.0F, 3.0F, 3.0F, 1.0F, 0.0F, false);
        ...
        left_pectoralFin.setTextureOffset(0, 0).func_228303_a_(0.0F, 0.0F, -2.0F, 13.0F, 0.0F, 5.0F, 0.0F, false);
        ...
        right_pectoralFin.setTextureOffset(0, 0).func_228303_a_(-13.0F, 0.0F, -2.0F, 13.0F, 0.0F, 5.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -1.0F, 4.0F);
        body.addChild(tail);
        tail.setTextureOffset(26, 6).func_228303_a_(-1.0F, -1.0F, 0.0F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        tail.setTextureOffset(0, 0).func_228303_a_(0.0F, -2.0F, 2.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this, "tail_fin");
        tail_fin.setRotationPoint(0.0F, 1.0F, 6.0F);
        tail.addChild(tail_fin);
        tail_fin.setTextureOffset(0, 6).func_228303_a_(0.0F, -5.0F, -1.0F, 0.0F, 8.0F, 9.0F, 0.0F, false);
        ...
        left_pelvicFin.setTextureOffset(0, 6).func_228303_a_(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 4.0F, 0.0F, false);
        ...
        right_pelvicFin.setTextureOffset(0, 6).func_228303_a_(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 4.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityFlyingFish) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }

    public void setRotationAngles(EntityFlyingFish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
