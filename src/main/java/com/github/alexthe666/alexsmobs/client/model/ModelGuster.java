...
public class ModelGuster extends AdvancedEntityModel<EntityGuster> {
    ...
    public ModelGuster() {
        ...
        tornado.setTextureOffset(65, 72).func_228303_a_(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);

        tornado2 = new AdvancedModelBox(this);
        tornado2.setRotationPoint(0.0F, -8.0F, 0.0F);
        tornado.addChild(tornado2);
        tornado2.setTextureOffset(0, 72).func_228303_a_(-8.0F, -4.0F, -8.0F, 16.0F, 8.0F, 16.0F, 0.0F, false);

        tornadomid = new AdvancedModelBox(this);
        tornadomid.setRotationPoint(0.0F, 6.0F, 0.0F);
        tornado2.addChild(tornadomid);
        tornadomid.setTextureOffset(16, 96).func_228303_a_(-14.0F, -4.0F, -14.0F, 28.0F, 4.0F, 28.0F, 0.0F, false);

        tornado3 = new AdvancedModelBox(this);
        tornado3.setRotationPoint(0.0F, -8.0F, 0.0F);
        tornado2.addChild(tornado3);
        tornado3.setTextureOffset(0, 39).func_228303_a_(-12.0F, -4.0F, -12.0F, 24.0F, 8.0F, 24.0F, 0.0F, false);

        tornado4 = new AdvancedModelBox(this);
        tornado4.setRotationPoint(0.0F, -8.0F, 0.0F);
        tornado3.addChild(tornado4);
        tornado4.setTextureOffset(0, 0).func_228303_a_(-15.0F, -4.0F, -15.0F, 30.0F, 8.0F, 30.0F, 0.0F, false);
        ...
        eye_left.setTextureOffset(8, 13).func_228303_a_(-3.0F, -4.0F, 0.0F, 6.0F, 8.0F, 0.0F, 0.0F, false);

        eye_right = new AdvancedModelBox(this);
        eye_right.setRotationPoint(-4.0F, 0.0F, 0.0F);
        eyes.addChild(eye_right);
        eye_right.setTextureOffset(8, 13).func_228303_a_(-3.0F, -4.0F, 0.0F, 6.0F, 8.0F, 0.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityGuster) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
