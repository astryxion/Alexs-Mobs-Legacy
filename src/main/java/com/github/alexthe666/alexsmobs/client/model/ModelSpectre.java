...
public class ModelSpectre extends AdvancedEntityModel<EntitySpectre> {
    ...
    public ModelSpectre() {
        ...
        body.setTextureOffset(43, 0).func_228303_a_(-12.0F, -5.5F, -12.0F, 24.0F, 6.0F, 24.0F, 0.0F, false);

        spine = new AdvancedModelBox(this);
        spine.setRotationPoint(0.0F, -5.5F, 0.0F);
        body.addChild(spine);
        setRotationAngle(spine, 0.0F, 0.7854F, 0.0F);
        spine.setTextureOffset(0, 0).func_228303_a_(0.0F, -3.0F, -14.0F, 0.0F, 8.0F, 42.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, 1.0F, 28.0F);
        spine.addChild(tail);
        tail.setTextureOffset(76, 31).func_228303_a_(0.0F, -6.0F, 0.0F, 0.0F, 11.0F, 27.0F, 0.0F, false);
        ...
        wing_left.setTextureOffset(76, 76).func_228303_a_(0.0F, -1.5F, 0.0F, 26.0F, 3.0F, 23.0F, 0.0F, false);
        ...
        wing_right.setTextureOffset(0, 51).func_228303_a_(-26.0F, -1.5F, 0.0F, 26.0F, 3.0F, 23.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntitySpectre) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
