...
public class ModelCosmicCod extends AdvancedEntityModel<EntityCosmicCod> {
    ...
    public ModelCosmicCod() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-1.0F, -1.0F, -5.0F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        body.setTextureOffset(15, 15).func_228303_a_(0.0F, -3.0F, -2.0F, 0.0F, 2.0F, 5.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(0, 12).func_228303_a_(0.0F, 0.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(0, 12).func_228303_a_(0.0F, 0.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, true);

        mouth = new AdvancedModelBox(this, "mouth");
        mouth.setRotationPoint(0.0F, 1.0F, -5.0F);
        body.addChild(mouth);
        mouth.setTextureOffset(0, 0).func_228303_a_(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 0.0F, 3.0F);
        body.addChild(tail);
        tail.setTextureOffset(15, 6).func_228303_a_(-0.5F, -1.0F, 0.0F, 1.0F, 2.0F, 6.0F, 0.0F, false);

        tail_tip = new AdvancedModelBox(this, "tail_tip");
        tail_tip.setRotationPoint(0.0F, 0.0F, 6.0F);
        tail.addChild(tail_tip);
        tail_tip.setTextureOffset(0, 12).func_228303_a_(0.0F, -3.0F, -1.0F, 0.0F, 5.0F, 7.0F, 0.0F, false);
        this.updateDefaultPose();
    }

    public void setRotationAngles(EntityCosmicCod entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float pitch = (entity.prevFishPitch + (entity.getFishPitch() - entity.prevFishPitch) * partialTick) * 0.0174532925F;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        setRotationAngles((EntityCosmicCod) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
