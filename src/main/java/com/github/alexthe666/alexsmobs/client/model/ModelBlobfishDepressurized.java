...
public class ModelBlobfishDepressurized extends AdvancedEntityModel<EntityBlobfish> {
    ...
    public ModelBlobfishDepressurized() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-4.0F, -3.5F, -9.0F, 8.0F, 6.0F, 9.0F, 0.0F, false);

        nose = new AdvancedModelBox(this);
        nose.setRotationPoint(0.0F, -0.5F, -9.0F);
        body.addChild(nose);
        nose.setTextureOffset(0, 0).func_228303_a_(-1.5F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, 0.75F, 0.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 16).func_228303_a_(-3.0F, -3.25F, 0.0F, 6.0F, 5.0F, 4.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this);
        tail_fin.setRotationPoint(0.0F, -0.25F, 4.0F);
        tail.addChild(tail_fin);
        tail_fin.setTextureOffset(16, 21).func_228303_a_(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 5.0F, 0.0F, false);
        ...
        fin_left.setTextureOffset(0, 4).func_228303_a_(0.0F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
        ...
        fin_right.setTextureOffset(0, 4).func_228303_a_(-3.0F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, true);
    ...
    public void setRotationAngles(EntityBlobfish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float lvt_6_1_ = entity.prevSquishFactor + (entity.squishFactor - entity.prevSquishFactor) * pt;
