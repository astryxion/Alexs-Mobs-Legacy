...
public class ModelVoidWormTail extends AdvancedEntityModel<EntityVoidWormPart> {
	...
	public ModelVoidWormTail() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-8.0F, -19.0F, 0.0F, 16.0F, 38.0F, 35.0F, 0.0F, false);
		...
		frillstop_left.setTextureOffset(65, 36).func_228303_a_(0.0F, -14.0F, -16.0F, 0.0F, 14.0F, 38.0F, 0.0F, false);
		...
		frillstop_right.setTextureOffset(65, 36).func_228303_a_(0.0F, -14.0F, -16.0F, 0.0F, 14.0F, 38.0F, 0.0F, true);
		...
		frillsbottom_left.setTextureOffset(65, 36).func_228303_a_(0.0F, -14.0F, -16.0F, 0.0F, 14.0F, 38.0F, 0.0F, false);
		...
		frillsbottom_right.setTextureOffset(65, 36).func_228303_a_(0.0F, -14.0F, -16.0F, 0.0F, 14.0F, 38.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityVoidWormPart) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
