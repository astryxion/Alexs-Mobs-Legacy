...
public class ModelFrilledShark extends AdvancedEntityModel<EntityFrilledShark> {
	...
	public ModelFrilledShark() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-3.0F, -3.0F, -15.0F, 6.0F, 6.0F, 18.0F, 0.0F, false);
		body.setTextureOffset(66, 59).func_228303_a_(0.0F, -9.0F, -14.0F, 0.0F, 6.0F, 17.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -2.0F, -15.0F);
		body.addChild(head);
		head.setTextureOffset(31, 0).func_228303_a_(-3.0F, -1.0F, -7.0F, 6.0F, 3.0F, 7.0F, 0.0F, false);

		jaw = new AdvancedModelBox(this);
		jaw.setRotationPoint(0.0F, 2.4F, 0.4F);
		head.addChild(jaw);
		setRotationAngle(jaw, 0.2618F, 0.0F, 0.0F);
		jaw.setTextureOffset(41, 25).func_228303_a_(-2.5F, 0.0F, -7.0F, 5.0F, 2.0F, 7.0F, 0.0F, false);
		...
		pectoralfin_left.setTextureOffset(41, 42).func_228303_a_(0.0F, 0.0F, 0.0F, 5.0F, 0.0F, 7.0F, 0.0F, false);
		...
		pectoralfin_right.setTextureOffset(41, 42).func_228303_a_(-5.0F, 0.0F, 0.0F, 5.0F, 0.0F, 7.0F, 0.0F, true);

		tail1 = new AdvancedModelBox(this);
		tail1.setRotationPoint(0.0F, -0.9F, 3.0F);
		body.addChild(tail1);
		tail1.setTextureOffset(21, 25).func_228303_a_(-2.0F, -2.0F, 0.0F, 4.0F, 5.0F, 11.0F, 0.0F, false);
		tail1.setTextureOffset(0, 25).func_228303_a_(0.0F, -5.0F, 5.0F, 0.0F, 3.0F, 6.0F, 0.0F, false);
		...
		pelvicfin_left.setTextureOffset(21, 25).func_228303_a_(0.0F, 0.0F, -1.0F, 0.0F, 3.0F, 5.0F, 0.0F, false);
		...
		pelvicfin_right.setTextureOffset(21, 25).func_228303_a_(0.0F, 0.0F, -1.0F, 0.0F, 3.0F, 5.0F, 0.0F, true);

		tail2 = new AdvancedModelBox(this);
		tail2.setRotationPoint(0.0F, 0.1F, 11.0F);
		tail1.addChild(tail2);
		tail2.setTextureOffset(0, 25).func_228303_a_(0.0F, -6.0F, 0.0F, 0.0F, 11.0F, 20.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityFrilledShark) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
