...
public class ModelCentipedeBody extends AdvancedEntityModel<EntityCentipedeBody> {
	...
	public ModelCentipedeBody() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-8.0F, -5.4F, -8.0F, 16.0F, 10.0F, 16.0F, 0.0F, false);
		...
		legfrontL1.setTextureOffset(21, 32).func_228303_a_(0.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, false);
		...
		legfrontL2.setTextureOffset(23, 27).func_228303_a_(0.0F, -1.0F, -1.0F, 9.0F, 2.0F, 2.0F, 0.0F, false);
		...
		legfrontR1.setTextureOffset(21, 32).func_228303_a_(-8.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, true);
		...
		legfrontR2.setTextureOffset(23, 27).func_228303_a_(-9.0F, -1.0F, -1.0F, 9.0F, 2.0F, 2.0F, 0.0F, true);
		...
		legbackL1.setTextureOffset(0, 32).func_228303_a_(0.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, false);
		...
		legbackL2.setTextureOffset(0, 27).func_228303_a_(0.0F, -1.0F, -1.0F, 9.0F, 2.0F, 2.0F, 0.0F, false);
		...
		legbackR1.setTextureOffset(0, 32).func_228303_a_(-8.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, 0.0F, true);
		...
		legbackR2.setTextureOffset(0, 27).func_228303_a_(-9.0F, -1.0F, -1.0F, 9.0F, 2.0F, 2.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCentipedeBody) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
