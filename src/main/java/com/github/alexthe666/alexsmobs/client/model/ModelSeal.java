...
public class ModelSeal extends AdvancedEntityModel<EntitySeal> {
    ...
    public ModelSeal() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-6.5F, -6.0F, -9.0F, 13.0F, 9.0F, 18.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, 1.0F, 9.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 28).func_228303_a_(-4.0F, -4.0F, 0.0F, 8.0F, 6.0F, 14.0F, 0.0F, false);
        ...
        leftLeg.setTextureOffset(45, 0).func_228303_a_(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 8.0F, 0.0F, false);
        ...
        rightLeg.setTextureOffset(45, 0).func_228303_a_(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 8.0F, 0.0F, true);

        leftArm = new AdvancedModelBox(this);
        leftArm.setRotationPoint(7.5F, 2.5F, -4.0F);
        body.addChild(leftArm);
        leftArm.setTextureOffset(31, 28).func_228303_a_(-1.0F, -0.5F, -2.0F, 8.0F, 1.0F, 5.0F, 0.0F, false);
        leftArm.setTextureOffset(0, 7).func_228303_a_(7.0F, 0.5F, -2.0F, 0.0F, 2.0F, 5.0F, 0.0F, false);

        rightArm = new AdvancedModelBox(this);
        rightArm.setRotationPoint(-7.5F, 2.5F, -4.0F);
        body.addChild(rightArm);
        rightArm.setTextureOffset(31, 28).func_228303_a_(-7.0F, -0.5F, -2.0F, 8.0F, 1.0F, 5.0F, 0.0F, true);
        rightArm.setTextureOffset(0, 7).func_228303_a_(-7.0F, 0.5F, -2.0F, 0.0F, 2.0F, 5.0F, 0.0F, true);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -1.0F, -5.0F);
        body.addChild(head);
        head.setTextureOffset(35, 39).func_228303_a_(-3.5F, -3.0F, -9.0F, 7.0F, 6.0F, 10.0F, 0.0F, false);
        head.setTextureOffset(0, 0).func_228303_a_(-2.5F, 0.0F, -12.0F, 5.0F, 3.0F, 3.0F, 0.0F, false);
        ...
        leftWhisker.setTextureOffset(0, 7).func_228303_a_(0.0F, -2.0F, 0.0F, 2.0F, 3.0F, 0.0F, 0.0F, false);
        ...
        rightWhisker.setTextureOffset(0, 7).func_228303_a_(-2.0F, -2.0F, 0.0F, 2.0F, 3.0F, 0.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntitySeal) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void setRotationAngles(EntitySeal entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float walkSpeed = this.isChild ? 0.25F : 0.5F;
        float walkDegree = 1F;
        ...
        int baskType = entity.isTearsEasterEgg() ? -1 : entity.getEntityId() % 5;
