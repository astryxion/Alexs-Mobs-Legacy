...
public class ModelCrow extends AdvancedEntityModel<EntityCrow> {
	...
	public ModelCrow() {
		...
		body.setTextureOffset(0, 0).func_228303_a_(-1.5F, -5.0F, 0.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);
		...
		leg_left.setTextureOffset(0, 17).func_228303_a_(-0.5F, -2.0F, -2.0F, 1.0F, 2.0F, 3.0F, 0.0F, false);
		...
		leg_right.setTextureOffset(0, 17).func_228303_a_(-0.5F, -2.0F, -2.0F, 1.0F, 2.0F, 3.0F, 0.0F, true);
		...
		wing_left.setTextureOffset(13, 13).func_228303_a_(-0.5F, 0.0F, -1.7F, 1.0F, 6.0F, 3.0F, 0.0F, false);
		...
		wing_right.setTextureOffset(13, 13).func_228303_a_(-0.5F, 0.0F, -1.7F, 1.0F, 6.0F, 3.0F, 0.0F, true);

		tail = new AdvancedModelBox(this);
		tail.setRotationPoint(0.0F, -0.1F, 3.0F);
		body.addChild(tail);
		setRotationAngle(tail, -0.1309F, 0.0F, 0.0F);
		tail.setTextureOffset(13, 0).func_228303_a_(-1.5F, 0.0F, -2.0F, 3.0F, 4.0F, 2.0F, -0.1F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -4.8F, 1.7F);
		body.addChild(head);
		setRotationAngle(head, -0.7418F, 0.0F, 0.0F);
		head.setTextureOffset(0, 9).func_228303_a_(-1.5F, -2.8F, -1.5F, 3.0F, 4.0F, 3.0F, -0.2F, false);

		beak = new AdvancedModelBox(this);
		beak.setRotationPoint(0.0F, -1.4F, -1.9F);
		head.addChild(beak);
		beak.setTextureOffset(13, 7).func_228303_a_(-0.5F, -1.0F, -1.8F, 1.0F, 2.0F, 3.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCrow) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
