...
public class ModelLeafcutterAnt extends AdvancedEntityModel<EntityLeafcutterAnt> {
	...
	public ModelLeafcutterAnt() {
		...
		root.addChild(body);
		body.setTextureOffset(14, 5).func_228303_a_(-1.0F, -0.4F, -2.125F, 2.0F, 2.0F, 5.0F, 0.0F, false);
		...
		legfront_left.setTextureOffset(0, 19).func_228303_a_(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		...
		legfront_right.setTextureOffset(0, 19).func_228303_a_(-4.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, true);

		legmid_left = new AdvancedModelBox(this);
		legmid_left.setRotationPoint(1.0F, 1.0F, 0.875F);
		body.addChild(legmid_left);
		legmid_left.setTextureOffset(0, 19).func_228303_a_(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);

		legmid_right = new AdvancedModelBox(this);
		legmid_right.setRotationPoint(-1.0F, 1.0F, 0.875F);
		body.addChild(legmid_right);
		legmid_right.setTextureOffset(0, 19).func_228303_a_(-4.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, true);
		...
		legback_left.setTextureOffset(0, 19).func_228303_a_(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		...
		legback_right.setTextureOffset(0, 19).func_228303_a_(-4.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, true);

		abdomen = new AdvancedModelBox(this);
		abdomen.setRotationPoint(0.0F, 0.0F, 2.875F);
		body.addChild(abdomen);
		abdomen.setTextureOffset(0, 0).func_228303_a_(-2.0F, -3.0F, 0.0F, 4.0F, 4.0F, 5.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -0.5F, -2.125F);
		body.addChild(head);
		head.setTextureOffset(0, 10).func_228303_a_(-2.0F, -2.0F, -4.0F, 4.0F, 3.0F, 5.0F, 0.0F, false);
		...
		leaf_r1.setTextureOffset(6, 5).func_228303_a_(0.0F, -14.0F, -6.0F, 0.0F, 14.0F, 13.0F, 0.0F, false);
		...
		antenna_left.setTextureOffset(12, 13).func_228303_a_(0.0F, 0.0F, -6.0F, 5.0F, 0.0F, 6.0F, 0.0F, false);
		...
		antenna_right.setTextureOffset(12, 13).func_228303_a_(-5.0F, 0.0F, -6.0F, 5.0F, 0.0F, 6.0F, 0.0F, true);

		fangs = new AdvancedModelBox(this);
		fangs.setRotationPoint(0.0F, 1.0F, -5.0F);
		head.addChild(fangs);
		fangs.setTextureOffset(14, 0).func_228303_a_(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
	...
	public void animateAnteater(EntityAnteater anteater, float partialTicks) {
		this.resetToDefaultPose();
		float ageInTicks = anteater.ticksExisted + partialTicks;
