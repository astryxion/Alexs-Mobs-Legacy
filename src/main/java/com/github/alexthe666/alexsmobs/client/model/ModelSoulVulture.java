...
public class ModelSoulVulture extends AdvancedEntityModel<EntitySoulVulture> {
	...
	public ModelSoulVulture() {
		...
		body.setTextureOffset(0, 0).func_228303_a_(-4.0F, -4.0F, -10.5F, 8.0F, 8.0F, 17.0F, 0.0F, false);

		heart = new AdvancedModelBox(this);
		heart.setRotationPoint(0.0F, 0.0F, -1.0F);
		body.addChild(heart);
		heart.setTextureOffset(0, 26).func_228303_a_(-2.0F, -2.0F, -6.0F, 4.0F, 4.0F, 5.0F, 0.0F, false);
		...
		leg_left.setTextureOffset(23, 26).func_228303_a_(-0.5F, 0.0F, -1.0F, 1.0F, 7.0F, 1.0F, 0.0F, false);

		foot_left = new AdvancedModelBox(this);
		foot_left.setRotationPoint(0.0F, 7.0F, -0.4F);
		leg_left.addChild(foot_left);
		foot_left.setTextureOffset(49, 27).func_228303_a_(-1.5F, 0.0F, -2.6F, 3.0F, 2.0F, 4.0F, 0.0F, false);
		...
		leg_right.setTextureOffset(23, 26).func_228303_a_(-0.5F, 0.0F, -1.0F, 1.0F, 7.0F, 1.0F, 0.0F, true);

		foot_right = new AdvancedModelBox(this);
		foot_right.setRotationPoint(0.0F, 7.0F, -0.4F);
		leg_right.addChild(foot_right);
		foot_right.setTextureOffset(49, 27).func_228303_a_(-1.5F, 0.0F, -2.6F, 3.0F, 2.0F, 4.0F, 0.0F, true);

		wing_left = new AdvancedModelBox(this);
		wing_left.setRotationPoint(4.0F, -3.0F, -10.0F);
		body.addChild(wing_left);
		wing_left.setTextureOffset(5, 31).func_228303_a_(0.0F, -1.0F, -0.5F, 1.0F, 9.0F, 24.0F, 0.0F, false);

		wing_right = new AdvancedModelBox(this);
		wing_right.setRotationPoint(-4.0F, -3.0F, -10.0F);
		body.addChild(wing_right);
		wing_right.setTextureOffset(5, 31).func_228303_a_(-1.0F, -1.0F, -0.5F, 1.0F, 9.0F, 24.0F, 0.0F, true);

		neck1 = new AdvancedModelBox(this);
		neck1.setRotationPoint(0.0F, -1.0F, -10.5F);
		body.addChild(neck1);
		setRotationAngle(neck1, 1.1345F, 0.0F, 0.0F);
		neck1.setTextureOffset(0, 0).func_228303_a_(-1.0F, -1.0F, -5.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);

		neck2 = new AdvancedModelBox(this);
		neck2.setRotationPoint(0.0F, -1.0F, -3.0F);
		neck1.addChild(neck2);
		neck2.setTextureOffset(34, 0).func_228303_a_(-1.0F, -4.0F, -2.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -4.0F, -1.5F);
		neck2.addChild(head);
		setRotationAngle(head, -0.6981F, 0.0F, 0.0F);
		head.setTextureOffset(0, 9).func_228303_a_(-2.0F, -3.0F, -2.0F, 4.0F, 3.0F, 4.0F, 0.0F, false);

		beak = new AdvancedModelBox(this);
		beak.setRotationPoint(0.0F, -1.4F, -2.0F);
		head.addChild(beak);
		beak.setTextureOffset(32, 32).func_228303_a_(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);

		tail = new AdvancedModelBox(this);
		tail.setRotationPoint(0.0F, -3.0F, 6.5F);
		body.addChild(tail);
		setRotationAngle(tail, 0.0436F, 0.0F, 0.0F);
		tail.setTextureOffset(38, 41).func_228303_a_(-3.0F, 0.0F, 0.0F, 6.0F, 2.0F, 7.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntitySoulVulture) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
