...
public class ModelMysteriousWorm extends AdvancedEntityModel<Entity> {
    ...
    public ModelMysteriousWorm() {
        ...
        root.addChild(head);
        head.setTextureOffset(14, 0).func_228303_a_(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 2.0F, 0.0F, false);
        head.setTextureOffset(0, 19).func_228303_a_(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);

        body1 = new AdvancedModelBox(this);
        body1.setRotationPoint(0.0F, 0.0F, 0.0F);
        head.addChild(body1);
        body1.setTextureOffset(0, 11).func_228303_a_(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 5.0F, 0.0F, false);

        body2 = new AdvancedModelBox(this);
        body2.setRotationPoint(0.0F, 0.0F, 5.0F);
        body1.addChild(body2);
        body2.setTextureOffset(10, 14).func_228303_a_(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 5.0F, 0.1F, false);

        body3 = new AdvancedModelBox(this);
        body3.setRotationPoint(0.0F, 0.0F, 5.0F);
        body2.addChild(body3);
        body3.setTextureOffset(0, 0).func_228303_a_(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 7.0F, 0.0F, false);
    ...
    public void animateStack(ItemStack itemStackIn) {
        ...
        float tick = Minecraft.getMinecraft().player == null ? 0 : partialTick + Minecraft.getMinecraft().player.ticksExisted;
