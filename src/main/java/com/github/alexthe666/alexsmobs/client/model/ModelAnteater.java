...
public class ModelAnteater extends AdvancedEntityModel<EntityAnteater> {
    ...
    public ModelAnteater() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-4.0F, -5.0F, -14.0F, 8.0F, 10.0F, 21.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -4.0F, -15.0F);
        body.addChild(head);
        head.setTextureOffset(38, 0).func_228303_a_(-2.0F, -1.0F, -7.0F, 4.0F, 5.0F, 8.0F, 0.0F, false);

        left_ear = new AdvancedModelBox(this, "left_ear");
        left_ear.setRotationPoint(2.0F, 0.0F, -4.0F);
        head.addChild(left_ear);
        left_ear.setTextureOffset(11, 0).func_228303_a_(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, 0.0F, false);

        right_ear = new AdvancedModelBox(this, "right_ear");
        right_ear.setRotationPoint(-2.0F, 0.0F, -4.0F);
        head.addChild(right_ear);
        right_ear.setTextureOffset(11, 0).func_228303_a_(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, 0.0F, true);

        snout = new AdvancedModelBox(this, "snout");
        snout.setRotationPoint(0.0F, 1.5F, -6.5F);
        head.addChild(snout);
        setRotationAngle(snout, 0.2618F, 0.0F, 0.0F);
        snout.setTextureOffset(28, 32).func_228303_a_(-1.0F, -1.0F, -10.0F, 2.0F, 3.0F, 10.0F, 0.0F, false);

        tongue1 = new AdvancedModelBox(this, "tongue1");
        tongue1.setRotationPoint(0.0F, 1.0F, -10.0F);
        snout.addChild(tongue1);
        tongue1.setTextureOffset(43, 32).func_228303_a_(-0.5F, 0.0F, -6.0F, 1.0F, 0.0F, 6.0F, 0.0F, false);

        tongue2 = new AdvancedModelBox(this, "tongue2");
        tongue2.setRotationPoint(0.0F, 0.0F, -6.0F);
        tongue1.addChild(tongue2);
        tongue2.setTextureOffset(38, 14).func_228303_a_(-0.5F, 0.0F, -6.0F, 1.0F, 0.0F, 6.0F, 0.0F, false);

        left_leg = new AdvancedModelBox(this, "left_leg");
        left_leg.setRotationPoint(2.5F, 4.0F, 5.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(0, 32).func_228303_a_(-1.5F, 1.0F, -2.0F, 3.0F, 8.0F, 4.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setRotationPoint(-2.5F, 4.0F, 5.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(0, 32).func_228303_a_(-1.5F, 1.0F, -2.0F, 3.0F, 8.0F, 4.0F, 0.0F, true);

        left_arm = new AdvancedModelBox(this, "left_arm");
        left_arm.setRotationPoint(3.1F, 4.0F, -11.9F);
        body.addChild(left_arm);
        left_arm.setTextureOffset(0, 0).func_228303_a_(-2.0F, -1.0F, -2.0F, 3.0F, 10.0F, 4.0F, 0.0F, false);

        left_claws = new AdvancedModelBox(this, "left_claws");
        left_claws.setRotationPoint(-1.0F, 9.0F, 2.0F);
        left_arm.addChild(left_claws);
        left_claws.setTextureOffset(13, 13).func_228303_a_(0.0F, -2.0F, 0.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        left_claws.setTextureOffset(0, 15).func_228303_a_(-1.0F, -2.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this, "right_arm");
        right_arm.setRotationPoint(-3.1F, 4.0F, -11.9F);
        body.addChild(right_arm);
        right_arm.setTextureOffset(0, 0).func_228303_a_(-1.0F, -1.0F, -2.0F, 3.0F, 10.0F, 4.0F, 0.0F, true);
        ...
        right_claws.setTextureOffset(13, 13).func_228303_a_(-1.0F, -2.0F, 0.0F, 1.0F, 2.0F, 2.0F, 0.0F, true);
        right_claws.setTextureOffset(0, 15).func_228303_a_(1.0F, -2.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -5.0F, 7.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 32).func_228303_a_(-2.0F, 0.0F, 0.0F, 4.0F, 11.0F, 19.0F, 0.0F, false);
    ...
    public void animate(EntityAnteater entity, float f, float f1, float f2, float f3, float f4) {
        float partialTick = f2 - entity.ticksExisted;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityAnteater) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }

    public void setRotationAngles(EntityAnteater entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        EntityAnteater entity = (EntityAnteater) entityIn;
        if (entity.isChild()) {
            float f = 1.35F;
            head.setScale(f, f, f);
            ...
            net.minecraft.client.renderer.GlStateManager.translate(0.0D, 1.5D, 0D);
