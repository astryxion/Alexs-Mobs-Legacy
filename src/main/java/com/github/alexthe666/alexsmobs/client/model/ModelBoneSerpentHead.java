...
public class ModelBoneSerpentHead extends AdvancedEntityModel<EntityBoneSerpent> {
    ...
    public ModelBoneSerpentHead() {
        ...
        hornL.setTextureOffset(61, 42).func_228303_a_(-0.1F, -3.0F, -5.0F, 5.0F, 5.0F, 16.0F, 0.0F, false);

        hornR = new AdvancedModelBox(this);
        hornR.setRotationPoint(-4.1F, -7.0F, -1.0F);
        head.addChild(hornR);
        setRotationAngle(hornR, 0.6545F, -0.3927F, 0.0F);
        hornR.setTextureOffset(61, 42).func_228303_a_(-4.9F, -3.0F, -5.0F, 5.0F, 5.0F, 16.0F, 0.0F, true);
        ...
        middlehorn.setTextureOffset(67, 67).func_228303_a_(-0.1F, -4.0F, -5.0F, 6.0F, 6.0F, 22.0F, 0.0F, false);

        headtop = new AdvancedModelBox(this);
        headtop.setRotationPoint(0.0F, -2.5F, 0.0F);
        head.addChild(headtop);
        headtop.setTextureOffset(0, 0).func_228303_a_(-9.0F, -4.5F, -30.0F, 18.0F, 11.0F, 30.0F, 0.0F, false);

        jaw = new AdvancedModelBox(this);
        jaw.setRotationPoint(0.0F, 2.5F, -2.0F);
        head.addChild(jaw);
        jaw.setTextureOffset(0, 42).func_228303_a_(-8.0F, -1.5F, -26.0F, 16.0F, 7.0F, 28.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityBoneSerpent) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
