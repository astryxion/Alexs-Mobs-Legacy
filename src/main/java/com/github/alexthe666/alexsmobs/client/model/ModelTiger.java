...
public class ModelTiger extends AdvancedEntityModel<EntityTiger> {
    ...
    public ModelTiger() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-5.0F, -6.0F, -12.0F, 10.0F, 11.0F, 22.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, -4.0F, 8.6F);
        body.addChild(tail);
        setRotationAngle(tail, 0.0873F, 0.0F, 0.0F);
        tail.setTextureOffset(46, 34).func_228303_a_(-1.5F, -1.0F, 0.0F, 3.0F, 9.0F, 3.0F, 0.0F, false);

        tail2 = new AdvancedModelBox(this);
        tail2.setRotationPoint(0.0F, 7.9F, 0.0F);
        tail.addChild(tail2);
        setRotationAngle(tail2, 0.2182F, 0.0F, 0.0F);
        tail2.setTextureOffset(43, 0).func_228303_a_(-1.5F, 0.0F, 0.0F, 3.0F, 9.0F, 3.0F, -0.1F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -4.0F, -12.0F);
        body.addChild(head);
        head.setTextureOffset(0, 34).func_228303_a_(-4.0F, -4.0F, -6.0F, 8.0F, 7.0F, 6.0F, 0.0F, false);
        head.setTextureOffset(9, 15).func_228303_a_(4.0F, -1.0F, -5.0F, 1.0F, 4.0F, 2.0F, 0.0F, false);
        head.setTextureOffset(9, 15).func_228303_a_(-5.0F, -1.0F, -5.0F, 1.0F, 4.0F, 2.0F, 0.0F, true);

        earleft = new AdvancedModelBox(this);
        earleft.setRotationPoint(3.0F, -4.0F, -2.0F);
        head.addChild(earleft);
        earleft.setTextureOffset(0, 15).func_228303_a_(0.0F, -2.0F, -2.0F, 1.0F, 2.0F, 3.0F, 0.0F, false);

        earright = new AdvancedModelBox(this);
        earright.setRotationPoint(-3.0F, -4.0F, -2.0F);
        head.addChild(earright);
        earright.setTextureOffset(0, 15).func_228303_a_(-1.0F, -2.0F, -2.0F, 1.0F, 2.0F, 3.0F, 0.0F, true);

        snout = new AdvancedModelBox(this);
        snout.setRotationPoint(0.0F, -1.0F, -6.0F);
        head.addChild(snout);
        setRotationAngle(snout, 0.1745F, 0.0F, 0.0F);
        snout.setTextureOffset(43, 13).func_228303_a_(-2.0F, 0.0F, -3.0F, 4.0F, 4.0F, 3.0F, 0.0F, false);

        legleft = new AdvancedModelBox(this);
        legleft.setRotationPoint(2.9F, 5.0F, 7.9F);
        body.addChild(legleft);
        legleft.setTextureOffset(0, 48).func_228303_a_(-2.0F, -2.0F, -3.0F, 4.0F, 11.0F, 5.0F, 0.0F, false);

        legright = new AdvancedModelBox(this);
        legright.setRotationPoint(-2.9F, 5.0F, 7.9F);
        body.addChild(legright);
        legright.setTextureOffset(0, 48).func_228303_a_(-2.0F, -2.0F, -3.0F, 4.0F, 11.0F, 5.0F, 0.0F, true);

        armleft = new AdvancedModelBox(this);
        armleft.setRotationPoint(3.5F, -1.5F, -9.0F);
        body.addChild(armleft);
        armleft.setTextureOffset(29, 34).func_228303_a_(-2.0F, -5.5F, -2.0F, 4.0F, 21.0F, 4.0F, 0.0F, false);

        armright = new AdvancedModelBox(this);
        armright.setRotationPoint(-3.5F, -1.5F, -9.0F);
        body.addChild(armright);
        armright.setTextureOffset(29, 34).func_228303_a_(-2.0F, -5.5F, -2.0F, 4.0F, 21.0F, 4.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityTiger) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
