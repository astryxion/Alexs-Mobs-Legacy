...
public class ModelCapuchinMonkey extends AdvancedEntityModel<EntityCapuchinMonkey> {
	...
	public ModelCapuchinMonkey() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-3.0F, -2.1F, -9.9F, 6.0F, 5.0F, 11.0F, 0.0F, false);

		arm_left = new AdvancedModelBox(this);
		arm_left.setRotationPoint(2.1F, 2.4F, -8.8F);
		body.addChild(arm_left);
		arm_left.setTextureOffset(28, 17).func_228303_a_(-1.0F, -1.5F, -1.0F, 2.0F, 9.0F, 2.0F, 0.0F, false);

		arm_right = new AdvancedModelBox(this);
		arm_right.setRotationPoint(-2.1F, 2.4F, -8.8F);
		body.addChild(arm_right);
		arm_right.setTextureOffset(28, 17).func_228303_a_(-1.0F, -1.5F, -1.0F, 2.0F, 9.0F, 2.0F, 0.0F, true);

		leg_left = new AdvancedModelBox(this);
		leg_left.setRotationPoint(2.0F, 2.9F, 0.1F);
		body.addChild(leg_left);
		leg_left.setTextureOffset(0, 0).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		leg_right = new AdvancedModelBox(this);
		leg_right.setRotationPoint(-2.0F, 2.9F, 0.1F);
		body.addChild(leg_right);
		leg_right.setTextureOffset(0, 0).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, true);

		tail1 = new AdvancedModelBox(this);
		tail1.setRotationPoint(0.0F, -1.1F, 0.5F);
		body.addChild(tail1);
		setRotationAngle(tail1, 0.6981F, 0.0F, 0.0F);
		tail1.setTextureOffset(15, 22).func_228303_a_(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 8.0F, 0.0F, false);
		...
		tail2_r1.setTextureOffset(0, 17).func_228303_a_(-1.0F, -0.8125F, -0.2209F, 2.0F, 3.0F, 9.0F, -0.1F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -1.1F, -9.9F);
		body.addChild(head);
		head.setTextureOffset(24, 0).func_228303_a_(-2.0F, -3.0F, -3.0F, 4.0F, 4.0F, 3.0F, 0.0F, false);

		hair = new AdvancedModelBox(this);
		hair.setRotationPoint(0.0F, -1.0F, -2.0F);
		head.addChild(hair);
		hair.setTextureOffset(6, 38).func_228303_a_(-3.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, 0.0F, false);

		snout = new AdvancedModelBox(this);
		snout.setRotationPoint(0.0F, 1.0F, -3.0F);
		head.addChild(snout);
		snout.setTextureOffset(0, 17).func_228303_a_(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCapuchinMonkey) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void setRotationAngles(EntityCapuchinMonkey entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		float sitProgress = entity.isRiding() ? 0 : entity.prevSitProgress + (entity.sitProgress - entity.prevSitProgress) * partialTick;
		float rideProgress = entity.isRiding() && entity.getRidingEntity() instanceof EntityLivingBase && entity.isOwner((EntityLivingBase) entity.getRidingEntity()) ? 10 : 0;
