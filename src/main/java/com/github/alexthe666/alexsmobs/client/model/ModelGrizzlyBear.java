...
public class ModelGrizzlyBear extends AdvancedEntityModel<EntityGrizzlyBear> {
    ...
    public ModelGrizzlyBear() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-7.0F, -7.0F, -19.0F, 14.0F, 15.0F, 28.0F, 0.0F, false);
        body.setTextureOffset(0, 44).func_228303_a_(-6.0F, 8.0F, -19.0F, 12.0F, 3.0F, 28.0F, 0.0F, false);

        midbody = new AdvancedModelBox(this);
        midbody.setRotationPoint(0.0F, 0.5F, -4.0F);
        body.addChild(midbody);
        midbody.setTextureOffset(27, 99).func_228303_a_(-8.0F, -8.5F, -6.0F, 16.0F, 17.0F, 12.0F, 0.1F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -0.8F, -21.0F);
        body.addChild(head);
        head.setTextureOffset(57, 0).func_228303_a_(-5.0F, -5.0F, -6.0F, 10.0F, 10.0F, 8.0F, 0.0F, false);

        snout = new AdvancedModelBox(this);
        snout.setRotationPoint(0.0F, 0.0F, -6.0F);
        head.addChild(snout);
        snout.setTextureOffset(0, 17).func_228303_a_(-2.0F, 0.0F, -5.0F, 4.0F, 5.0F, 5.0F, 0.0F, false);

        left_ear = new AdvancedModelBox(this);
        left_ear.setRotationPoint(3.5F, -5.0F, -3.0F);
        head.addChild(left_ear);
        left_ear.setTextureOffset(14, 17).func_228303_a_(-1.5F, -2.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);

        right_ear = new AdvancedModelBox(this);
        right_ear.setRotationPoint(-3.5F, -5.0F, -3.0F);
        head.addChild(right_ear);
        right_ear.setTextureOffset(14, 17).func_228303_a_(-1.5F, -2.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, true);

        left_leg = new AdvancedModelBox(this);
        left_leg.setRotationPoint(3.8F, 8.0F, 4.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(0, 76).func_228303_a_(-3.0F, 0.0F, -3.0F, 6.0F, 11.0F, 8.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this);
        right_leg.setRotationPoint(-3.8F, 8.0F, 4.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(0, 76).func_228303_a_(-3.0F, 0.0F, -3.0F, 6.0F, 11.0F, 8.0F, 0.0F, true);

        left_arm = new AdvancedModelBox(this);
        left_arm.setRotationPoint(4.5F, 4.0F, -13.0F);
        body.addChild(left_arm);
        left_arm.setTextureOffset(74, 78).func_228303_a_(-3.0F, -3.0F, -3.0F, 6.0F, 18.0F, 7.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this);
        right_arm.setRotationPoint(-4.5F, 4.0F, -13.0F);
        body.addChild(right_arm);
        right_arm.setTextureOffset(74, 78).func_228303_a_(-3.0F, -3.0F, -3.0F, 6.0F, 18.0F, 7.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityGrizzlyBear) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
