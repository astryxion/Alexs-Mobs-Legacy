...
public class ModelEnderiophage extends AdvancedEntityModel<EntityEnderiophage> {
    ...
    public ModelEnderiophage() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 30).func_228303_a_(-4.0F, -2.0F, -4.0F, 8.0F, 3.0F, 8.0F, 0.0F, false);

        mouth = new AdvancedModelBox(this);
        mouth.setRotationPoint(0.0F, 1.0F, 0.0F);
        body.addChild(mouth);
        mouth.setTextureOffset(0, 0).func_228303_a_(-1.0F, -5.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

        sheath = new AdvancedModelBox(this);
        sheath.setRotationPoint(0.0F, -2.0F, 0.0F);
        body.addChild(sheath);
        sheath.setTextureOffset(50, 43).func_228303_a_(-2.0F, -14.0F, -2.0F, 4.0F, 14.0F, 4.0F, 0.0F, false);

        collar = new AdvancedModelBox(this);
        collar.setRotationPoint(0.0F, -14.0F, 0.0F);
        sheath.addChild(collar);
        collar.setTextureOffset(0, 55).func_228303_a_(-3.0F, -1.0F, -3.0F, 6.0F, 1.0F, 6.0F, 0.0F, false);

        capsid = new AdvancedModelBox(this);
        capsid.setRotationPoint(0.0F, -1.0F, 0.0F);
        collar.addChild(capsid);
        capsid.setTextureOffset(0, 0).func_228303_a_(-7.0F, -15.0F, -7.0F, 14.0F, 15.0F, 14.0F, 0.0F, false);

        eye = new AdvancedModelBox(this);
        eye.setRotationPoint(0.0F, -8.0F, 0.0F);
        capsid.addChild(eye);
        eye.setTextureOffset(43, 0).func_228303_a_(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);
        ...
        tailmid_left.setTextureOffset(25, 43).func_228303_a_(0.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, false);
        ...
        tailmid_right.setTextureOffset(25, 43).func_228303_a_(-12.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, true);
        ...
        tailback_left.setTextureOffset(33, 30).func_228303_a_(0.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, false);
        ...
        tailback_right.setTextureOffset(33, 30).func_228303_a_(-12.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, true);
        ...
        tailfront_left.setTextureOffset(0, 42).func_228303_a_(0.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, false);
        ...
        tailfront_right.setTextureOffset(0, 42).func_228303_a_(-12.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityEnderiophage) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void setRotationAngles(EntityEnderiophage entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float phagePitch = (float) Math.toRadians(entity.prevPhagePitch + (entity.getPhagePitch() - entity.prevPhagePitch) * partialTicks);
        float totalYaw = (float) Math.toRadians(entity.prevRenderYawOffset + (entity.renderYawOffset - entity.prevRenderYawOffset) * partialTicks);
        ...
        if (look != null) {
            Vec3d vector3d = look.getPositionEyes(partialTicks);
            Vec3d vector3d1 = entity.getPositionEyes(partialTicks);
            ...
            this.eye.rotateAngleX += -MathHelper.clamp((float) vector3d2.y * 0.5F, (float) (Math.PI * -0.5F), (float) (Math.PI * 0.5F)) + phagePitch * flyProgress * 0.2F;
        }
    }
