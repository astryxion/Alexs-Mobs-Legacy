...
public class ModelStraddler extends AdvancedEntityModel<EntityStraddler> {
    ...
    public ModelStraddler() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-14.0F, -12.0F, -7.0F, 28.0F, 11.0F, 14.0F, 0.0F, false);

        hair = new AdvancedModelBox(this);
        hair.setRotationPoint(0.0F, -13.0F, 0.0F);
        body.addChild(hair);
        hair.setTextureOffset(23, 26).func_228303_a_(-6.0F, -4.0F, 0.0F, 12.0F, 5.0F, 0.0F, 0.0F, false);

        horn_left = new AdvancedModelBox(this);
        horn_left.setRotationPoint(9.5F, -12.0F, -4.0F);
        body.addChild(horn_left);
        horn_left.setTextureOffset(0, 26).func_228303_a_(-2.5F, -18.0F, 0.0F, 6.0F, 18.0F, 10.0F, 0.0F, false);
        ...
        hair_left.setTextureOffset(33, 33).func_228303_a_(0.0F, 0.0F, 0.0F, 0.0F, 6.0F, 16.0F, 0.0F, false);

        horn_right = new AdvancedModelBox(this);
        horn_right.setRotationPoint(-9.5F, -12.0F, -4.0F);
        body.addChild(horn_right);
        horn_right.setTextureOffset(0, 26).func_228303_a_(-3.5F, -18.0F, 0.0F, 6.0F, 18.0F, 10.0F, 0.0F, true);
        ...
        hair_right.setTextureOffset(33, 33).func_228303_a_(0.0F, 0.0F, 0.0F, 0.0F, 6.0F, 16.0F, 0.0F, true);

        leg_left = new AdvancedModelBox(this);
        leg_left.setRotationPoint(7.0F, -0.5F, 0.0F);
        body.addChild(leg_left);
        leg_left.setTextureOffset(50, 26).func_228303_a_(-3.0F, -0.5F, -3.0F, 6.0F, 15.0F, 6.0F, 0.0F, false);

        leg_right = new AdvancedModelBox(this);
        leg_right.setRotationPoint(-7.0F, -0.5F, 0.0F);
        body.addChild(leg_right);
        leg_right.setTextureOffset(50, 26).func_228303_a_(-3.0F, -0.5F, -3.0F, 6.0F, 15.0F, 6.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityStraddler) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
