...
public class ModelKangaroo extends AdvancedEntityModel<EntityKangaroo> {
	...
	public ModelKangaroo() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-5.0F, -6.0F, -6.0F, 10.0F, 11.0F, 13.0F, 0.0F, false);

		pouch = new AdvancedModelBox(this);
		pouch.setRotationPoint(0.0F, 2.7F, -2.2F);
		body.addChild(pouch);
		pouch.setTextureOffset(64, 6).func_228303_a_(-3.5F, -2.5F, -4.0F, 7.0F, 5.0F, 8.0F, -0.1F, false);

		tail1 = new AdvancedModelBox(this);
		tail1.setRotationPoint(0.0F, -5.0F, 7.0F);
		body.addChild(tail1);
		tail1.setTextureOffset(0, 25).func_228303_a_(-2.5F, 0.0F, 0.0F, 5.0F, 6.0F, 15.0F, 0.0F, false);

		tail2 = new AdvancedModelBox(this);
		tail2.setRotationPoint(0.0F, 4.0F, 15.0F);
		tail1.addChild(tail2);
		tail2.setTextureOffset(26, 32).func_228303_a_(-1.5F, -3.0F, 0.0F, 3.0F, 4.0F, 15.0F, 0.0F, false);

		leg_left = new AdvancedModelBox(this);
		leg_left.setRotationPoint(4.25F, 0.75F, -0.5F);
		body.addChild(leg_left);
		leg_left.setTextureOffset(48, 28).func_228303_a_(-1.25F, -3.75F, -3.5F, 3.0F, 7.0F, 8.0F, 0.0F, false);

		knee_left = new AdvancedModelBox(this);
		knee_left.setRotationPoint(0.25F, 3.25F, -3.5F);
		leg_left.addChild(knee_left);
		knee_left.setTextureOffset(0, 0).func_228303_a_(-1.0F, 0.0F, 0.0F, 2.0F, 9.0F, 3.0F, 0.0F, false);

		foot_left = new AdvancedModelBox(this);
		foot_left.setRotationPoint(0.0F, 9.0F, 1.0F);
		knee_left.addChild(foot_left);
		foot_left.setTextureOffset(35, 13).func_228303_a_(-1.5F, 0.0F, -10.0F, 3.0F, 2.0F, 12.0F, 0.0F, false);

		leg_right = new AdvancedModelBox(this);
		leg_right.setRotationPoint(-4.25F, 0.75F, -0.5F);
		body.addChild(leg_right);
		leg_right.setTextureOffset(48, 28).func_228303_a_(-1.75F, -3.75F, -3.5F, 3.0F, 7.0F, 8.0F, 0.0F, true);

		knee_right = new AdvancedModelBox(this);
		knee_right.setRotationPoint(-0.25F, 3.25F, -3.5F);
		leg_right.addChild(knee_right);
		knee_right.setTextureOffset(0, 0).func_228303_a_(-1.0F, 0.0F, 0.0F, 2.0F, 9.0F, 3.0F, 0.0F, true);

		foot_right = new AdvancedModelBox(this);
		foot_right.setRotationPoint(0.0F, 9.0F, 1.0F);
		knee_right.addChild(foot_right);
		foot_right.setTextureOffset(35, 13).func_228303_a_(-1.5F, 0.0F, -10.0F, 3.0F, 2.0F, 12.0F, 0.0F, true);

		chest = new AdvancedModelBox(this);
		chest.setRotationPoint(0.0F, -6.0F, -6.0F);
		body.addChild(chest);
		chest.setTextureOffset(0, 47).func_228303_a_(-4.0F, 0.0F, -9.0F, 8.0F, 9.0F, 9.0F, 0.0F, false);

		arm_left = new AdvancedModelBox(this);
		arm_left.setRotationPoint(4.0F, 6.0F, -6.0F);
		chest.addChild(arm_left);
		arm_left.setTextureOffset(71, 49).func_228303_a_(-1.0F, -1.0F, -2.0F, 2.0F, 12.0F, 3.0F, 0.0F, false);

		arm_right = new AdvancedModelBox(this);
		arm_right.setRotationPoint(-4.0F, 6.0F, -6.0F);
		chest.addChild(arm_right);
		arm_right.setTextureOffset(71, 49).func_228303_a_(-1.0F, -1.0F, -2.0F, 2.0F, 12.0F, 3.0F, 0.0F, true);

		neck = new AdvancedModelBox(this);
		neck.setRotationPoint(0.0F, 2.0F, -8.0F);
		chest.addChild(neck);
		neck.setTextureOffset(35, 52).func_228303_a_(-2.0F, -6.0F, -3.0F, 4.0F, 11.0F, 5.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -6.0F, -0.5F);
		neck.addChild(head);
		head.setTextureOffset(34, 0).func_228303_a_(-2.5F, -4.0F, -3.5F, 5.0F, 4.0F, 6.0F, 0.0F, false);
		...
		ear_left.setTextureOffset(0, 47).func_228303_a_(0.0F, -6.0F, -1.0F, 3.0F, 6.0F, 1.0F, 0.0F, false);
		...
		ear_right.setTextureOffset(0, 47).func_228303_a_(-3.0F, -6.0F, -1.0F, 3.0F, 6.0F, 1.0F, 0.0F, true);
		...
		head.addChild(snout);
		snout.setTextureOffset(0, 25).func_228303_a_(-1.5F, -1.5F, -4.0F, 3.0F, 3.0F, 4.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityKangaroo) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void setRotationAngles(EntityKangaroo entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		ItemStack EnumHand = entity.getItemStackFromSlot(EntityEquipmentSlot.MAINHAND);
		if(!helmet.isEmpty()){
		...
		if(entity.isChild() && entity.isRiding() && entity.getRidingEntity() instanceof EntityKangaroo) {
