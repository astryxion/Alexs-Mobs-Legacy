...
public class ModelCrocodile extends AdvancedEntityModel<EntityCrocodile> {
    ...
    public ModelCrocodile() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-8.0F, -4.625F, -14.125F, 16.0F, 11.0F, 35.0F, 0.0F, false);

        neck = new AdvancedModelBox(this);
        neck.setRotationPoint(0.0F, 1.125F, -14.375F);
        body.addChild(neck);
        neck.setTextureOffset(70, 47).func_228303_a_(-6.0F, -4.75F, -8.75F, 12.0F, 9.0F, 9.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -0.9167F, -8.4167F);
        neck.addChild(head);
        head.setTextureOffset(32, 90).func_228303_a_(-5.0F, -3.8333F, -9.3333F, 10.0F, 5.0F, 9.0F, 0.0F, false);

        snout = new AdvancedModelBox(this);
        snout.setRotationPoint(0.0F, 1.1667F, -1.3333F);
        head.addChild(snout);
        snout.setTextureOffset(0, 0).func_228303_a_(-3.0F, -4.0F, -19.0F, 6.0F, 4.0F, 11.0F, 0.0F, false);
        ...
        TeethLTop.setTextureOffset(0, 16).func_228303_a_(-2.1F, 0.1F, -5.5F, 3.0F, 2.0F, 11.0F, 0.0F, false);
        ...
        TeethRTop.setTextureOffset(0, 16).func_228303_a_(-0.9F, 0.1F, -5.5F, 3.0F, 2.0F, 11.0F, 0.0F, true);

        jaw = new AdvancedModelBox(this);
        jaw.setRotationPoint(0.0F, 0.9167F, -3.0833F);
        head.addChild(jaw);
        jaw.setTextureOffset(0, 78).func_228303_a_(-5.5F, -0.75F, -6.05F, 11.0F, 4.0F, 9.0F, 0.0F, false);

        jaw2 = new AdvancedModelBox(this);
        jaw2.setRotationPoint(0.5F, 6.25F, 1.75F);
        jaw.addChild(jaw2);
        jaw2.setTextureOffset(0, 93).func_228303_a_(-3.5F, -6.0F, -18.8F, 6.0F, 3.0F, 12.0F, 0.0F, false);
        ...
        TeethLBottom.setTextureOffset(93, 66).func_228303_a_(-1.4F, -0.9F, -5.5F, 3.0F, 2.0F, 11.0F, 0.0F, false);
        ...
        TeethRBottom.setTextureOffset(93, 66).func_228303_a_(-1.6F, -0.9F, -5.5F, 3.0F, 2.0F, 11.0F, 0.0F, true);

        LLegFront = new AdvancedModelBox(this);
        LLegFront.setRotationPoint(8.0F, 0.875F, -9.625F);
        body.addChild(LLegFront);
        LLegFront.setTextureOffset(0, 47).func_228303_a_(-2.0F, -2.5F, -2.5F, 4.0F, 11.0F, 5.0F, 0.0F, false);

        RLegFront = new AdvancedModelBox(this);
        RLegFront.setRotationPoint(-8.0F, 0.875F, -9.625F);
        body.addChild(RLegFront);
        RLegFront.setTextureOffset(0, 47).func_228303_a_(-2.0F, -2.5F, -2.5F, 4.0F, 11.0F, 5.0F, 0.0F, true);

        LLegBack = new AdvancedModelBox(this);
        LLegBack.setRotationPoint(8.0F, 0.875F, 13.875F);
        body.addChild(LLegBack);
        LLegBack.setTextureOffset(65, 99).func_228303_a_(-2.0F, -2.5F, -3.0F, 4.0F, 11.0F, 6.0F, 0.0F, false);

        RLegBack = new AdvancedModelBox(this);
        RLegBack.setRotationPoint(-8.0F, 0.875F, 13.875F);
        body.addChild(RLegBack);
        RLegBack.setTextureOffset(65, 99).func_228303_a_(-2.0F, -2.5F, -3.0F, 4.0F, 11.0F, 6.0F, 0.0F, true);

        Tail1 = new AdvancedModelBox(this);
        Tail1.setRotationPoint(0.0F, 0.875F, 23.375F);
        body.addChild(Tail1);
        Tail1.setTextureOffset(0, 47).func_228303_a_(-5.0F, -4.5F, -2.5F, 10.0F, 10.0F, 20.0F, 0.0F, false);

        Tail2 = new AdvancedModelBox(this);
        Tail2.setRotationPoint(0.0F, 0.25F, 19.5F);
        Tail1.addChild(Tail2);
        Tail2.setTextureOffset(68, 0).func_228303_a_(-3.0F, -3.75F, -2.0F, 6.0F, 9.0F, 18.0F, 0.0F, false);
        Tail2.setTextureOffset(72, 102).func_228303_a_(-3.0F, -6.75F, -2.0F, 6.0F, 3.0F, 18.0F, 0.0F, false);

        Tail3 = new AdvancedModelBox(this);
        Tail3.setRotationPoint(0.0F, 1.25F, 17.0F);
        Tail2.addChild(Tail3);
        Tail3.setTextureOffset(70, 70).func_228303_a_(0.0F, -10.0F, -1.0F, 0.0F, 6.0F, 22.0F, 0.0F, false);
        Tail3.setTextureOffset(39, 56).func_228303_a_(-2.0F, -4.0F, -1.0F, 4.0F, 8.0F, 22.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCrocodile) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void render(net.minecraft.entity.Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        if (this.isChild) {
            ...
            this.head.setScale(headScale, headScale, headScale);
