...
public class ModelPlatypus extends AdvancedEntityModel<EntityPlatypus> {
    ...
    public ModelPlatypus() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 2).func_228303_a_(-3.5F, -3.4F, -5.9F, 7.0F, 6.0F, 11.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -0.4F, -5.9F);
        body.addChild(head);
        head.setTextureOffset(5, 51).func_228303_a_(-3.0F, -2.5F, -4.0F, 6.0F, 5.0F, 4.0F, 0.0F, false);

        beak = new AdvancedModelBox(this);
        beak.setRotationPoint(0.0F, 2.0F, -5.0F);
        head.addChild(beak);
        beak.setTextureOffset(28, 0).func_228303_a_(-2.0F, -2.0F, -3.0F, 4.0F, 2.0F, 4.0F, 0.0F, false);

        fedora = new AdvancedModelBox(this);
        fedora.setRotationPoint(0.0F, -2.6F, -1.9F);
        head.addChild(fedora);
        fedora.setTextureOffset(23, 20).func_228303_a_(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, 0.0F, false);
        fedora.setTextureOffset(29, 30).func_228303_a_(-2.0F, -2.0F, -2.0F, 4.0F, 2.0F, 4.0F, 0.0F, false);

        arm_left = new AdvancedModelBox(this);
        arm_left.setRotationPoint(3.5F, 2.1F, -4.9F);
        body.addChild(arm_left);
        arm_left.setTextureOffset(7, 39).func_228303_a_(0.0F, -0.5F, 0.0F, 3.0F, 1.0F, 3.0F, 0.0F, false);

        arm_right = new AdvancedModelBox(this);
        arm_right.setRotationPoint(-3.5F, 2.1F, -4.9F);
        body.addChild(arm_right);
        arm_right.setTextureOffset(7, 39).func_228303_a_(-3.0F, -0.5F, 0.0F, 3.0F, 1.0F, 3.0F, 0.0F, true);

        leg_left = new AdvancedModelBox(this);
        leg_left.setRotationPoint(3.5F, 2.1F, 2.6F);
        body.addChild(leg_left);
        leg_left.setTextureOffset(27, 43).func_228303_a_(0.0F, -0.5F, -0.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);

        leg_right = new AdvancedModelBox(this);
        leg_right.setRotationPoint(-3.5F, 2.1F, 2.6F);
        body.addChild(leg_right);
        leg_right.setTextureOffset(27, 43).func_228303_a_(-3.0F, -0.5F, -0.5F, 3.0F, 1.0F, 3.0F, 0.0F, true);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, -0.4F, 5.1F);
        body.addChild(tail);
        tail.setTextureOffset(0, 24).func_228303_a_(-3.0F, -1.0F, 0.0F, 6.0F, 3.0F, 8.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityPlatypus) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
