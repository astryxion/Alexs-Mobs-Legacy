...
public class ModelWarpedToad extends AdvancedEntityModel<EntityWarpedToad> {
    ...
    public ModelWarpedToad() {
        ...
        body_r1.setTextureOffset(0, 0).func_228303_a_(-7.0F, -5.0F, -8.0F, 14.0F, 10.0F, 16.0F, 0.0F, false);
        ...
        glowy_glands_left_r1.setTextureOffset(0, 41).func_228303_a_(-2.5F, -2.0F, -3.5F, 5.0F, 5.0F, 9.0F, 0.0F, false);
        ...
        glowy_glands_right_r1.setTextureOffset(0, 41).func_228303_a_(-2.5F, -2.0F, -3.5F, 5.0F, 5.0F, 9.0F, 0.0F, true);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -4.5F, -7.0F);
        body.addChild(head);
        head.setTextureOffset(30, 32).func_228303_a_(-5.0F, -3.5F, -9.0F, 10.0F, 4.0F, 9.0F, 0.0F, false);

        eye_left = new AdvancedModelBox(this);
        eye_left.setRotationPoint(5.0F, -4.0F, -4.5F);
        head.addChild(eye_left);
        eye_left.setTextureOffset(20, 43).func_228303_a_(-1.0F, -1.5F, -1.5F, 2.0F, 3.0F, 3.0F, 0.0F, false);

        eye_right = new AdvancedModelBox(this);
        eye_right.setRotationPoint(-5.0F, -4.0F, -4.5F);
        head.addChild(eye_right);
        eye_right.setTextureOffset(20, 43).func_228303_a_(-1.0F, -1.5F, -1.5F, 2.0F, 3.0F, 3.0F, 0.0F, true);

        jaw = new AdvancedModelBox(this);
        jaw.setRotationPoint(0.0F, 0.5F, -1.5F);
        head.addChild(jaw);
        jaw.setTextureOffset(0, 27).func_228303_a_(-5.0F, -0.1F, -7.5F, 10.0F, 4.0F, 9.0F, -0.1F, false);

        tongue = new AdvancedModelBox(this);
        tongue.setRotationPoint(0.0F, 1.0F, 0.5F);
        jaw.addChild(tongue);
        setRotationAngle(tongue, -0.6981F, 0.0F, 0.0F);
        tongue.setTextureOffset(52, 52).func_228303_a_(-1.0F, -1.0F, -6.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);

        leg_left = new AdvancedModelBox(this);
        leg_left.setRotationPoint(7.0F, 1.4F, 3.5F);
        body.addChild(leg_left);
        setRotationAngle(leg_left, -0.48F, 0.0F, 0.0F);
        leg_left.setTextureOffset(29, 46).func_228303_a_(-1.0F, -2.5F, -3.5F, 4.0F, 8.0F, 7.0F, 0.0F, false);
        ...
        foot_left.setTextureOffset(45, 0).func_228303_a_(-1.5F, 0.0F, -10.0F, 3.0F, 1.0F, 10.0F, 0.0F, false);
        ...
        leg_right.setTextureOffset(29, 46).func_228303_a_(-3.0F, -2.5F, -3.5F, 4.0F, 8.0F, 7.0F, 0.0F, true);
        ...
        foot_right.setTextureOffset(45, 0).func_228303_a_(-1.5F, 0.0F, -10.0F, 3.0F, 1.0F, 10.0F, 0.0F, true);

        arm_left = new AdvancedModelBox(this);
        arm_left.setRotationPoint(5.4F, 0.5F, -8.0F);
        body.addChild(arm_left);
        arm_left.setTextureOffset(0, 0).func_228303_a_(-1.5F, -1.5F, -1.5F, 3.0F, 9.0F, 3.0F, 0.0F, false);

        arm_right = new AdvancedModelBox(this);
        arm_right.setRotationPoint(-5.4F, 0.5F, -8.0F);
        body.addChild(arm_right);
        arm_right.setTextureOffset(0, 0).func_228303_a_(-1.5F, -1.5F, -1.5F, 3.0F, 9.0F, 3.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityWarpedToad) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        if (this.isChild) {
            ...
            GlStateManager.translate(0.0F, 2.75F, 0.125F);
