...
public class ModelSpikedTurtleShell extends ModelBiped {
    ...
    public ModelSpikedTurtleShell(float modelSize) {
        ...
        this.head.setTextureOffset(34, 15).addBox(0.0F, -33F, -4.5F, 4, 1, 9, modelSize - 0.1F);
        this.head.setTextureOffset(34, 15).addBox(-4.0F, -33F, -4.5F, 4, 1, 9, modelSize - 0.1F);
