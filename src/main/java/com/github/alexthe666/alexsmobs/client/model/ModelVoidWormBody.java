...
public class ModelVoidWormBody extends AdvancedEntityModel<EntityVoidWormPart> {
	...
	public ModelVoidWormBody() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-7.0F, -12.0F, 0.0F, 14.0F, 26.0F, 21.0F, 0.0F, false);
		...
		frillstop_left_r1.setTextureOffset(0, 48).func_228303_a_(0.0F, -8.0F, -10.0F, 0.0F, 8.0F, 21.0F, 0.0F, false);
		...
		frillstop_right_r1.setTextureOffset(0, 48).func_228303_a_(0.0F, -8.0F, -10.0F, 0.0F, 8.0F, 21.0F, 0.0F, true);
		...
		frillsbottom_left_r1.setTextureOffset(0, 48).func_228303_a_(0.0F, -8.0F, -10.0F, 0.0F, 8.0F, 21.0F, 0.0F, false);
		...
		frillsbottom_right_r1.setTextureOffset(0, 48).func_228303_a_(0.0F, -8.0F, -10.0F, 0.0F, 8.0F, 21.0F, 0.0F, true);
