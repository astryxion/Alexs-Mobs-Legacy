...
public class ModelHummingbird extends AdvancedEntityModel<EntityHummingbird> {
    ...
    public ModelHummingbird() {
        ...
        body.setTextureOffset(0, 6).func_228303_a_(-1.5F, -4.7F, -1.4F, 3.0F, 5.0F, 3.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -4.4F, 0.6F);
        body.addChild(head);
        setRotationAngle(head, -0.2182F, 0.0F, 0.0F);
        head.setTextureOffset(10, 12).func_228303_a_(-1.5F, -3.1F, -2.1F, 3.0F, 3.0F, 3.0F, 0.1F, false);
        head.setTextureOffset(12, 0).func_228303_a_(-0.5F, -2.1F, -5.2F, 1.0F, 1.0F, 3.0F, 0.0F, false);
        ...
        wingL_r1.setTextureOffset(0, 15).func_228303_a_(0.0F, 0.0F, -0.1F, 1.0F, 5.0F, 2.0F, 0.0F, false);
        ...
        wingR_r1.setTextureOffset(0, 15).func_228303_a_(-1.0F, 0.0F, -0.1F, 1.0F, 5.0F, 2.0F, 0.0F, true);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, -0.1F, 1.5F);
        body.addChild(tail);
        setRotationAngle(tail, -0.48F, 0.0F, 0.0F);
        tail.setTextureOffset(0, 0).func_228303_a_(-1.5F, 0.0F, 0.0F, 3.0F, 0.0F, 5.0F, 0.0F, false);

        legL = new AdvancedModelBox(this);
        legL.setRotationPoint(0.9F, -0.7F, -1.1F);
        body.addChild(legL);
        setRotationAngle(legL, -0.2618F, 0.0F, 0.0F);
        legL.setTextureOffset(0, 0).func_228303_a_(-0.5F, 0.0F, -1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);

        legR = new AdvancedModelBox(this);
        legR.setRotationPoint(-0.9F, -0.7F, -1.1F);
        body.addChild(legR);
        setRotationAngle(legR, -0.2618F, 0.0F, 0.0F);
        legR.setTextureOffset(0, 0).func_228303_a_(-0.5F, 0.0F, -1.0F, 1.0F, 1.0F, 1.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityHummingbird) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
