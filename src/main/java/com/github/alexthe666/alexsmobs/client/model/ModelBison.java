...
public class ModelBison extends AdvancedEntityModel<EntityBison> {
    ...
    public ModelBison() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 54).func_228303_a_(-9.0F, -11.0F, -1.0F, 18.0F, 20.0F, 19.0F, 0.0F, false);

        left_leg = new AdvancedModelBox(this);
        left_leg.setRotationPoint(5.8F, 5.0F, 14.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(75, 80).func_228303_a_(-3.0F, 4.0F, -3.0F, 6.0F, 14.0F, 7.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this);
        right_leg.setRotationPoint(-5.8F, 5.0F, 14.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(75, 80).func_228303_a_(-3.0F, 4.0F, -3.0F, 6.0F, 14.0F, 7.0F, 0.0F, true);
        ...
        tail_r1.setTextureOffset(0, 54).func_228303_a_(-1.5F, 0.0F, 0.0F, 3.0F, 14.0F, 0.0F, 0.0F, false);

        torso = new AdvancedModelBox(this);
        torso.setRotationPoint(0.0F, -3.0F, 1.0F);
        body.addChild(torso);
        torso.setTextureOffset(0, 0).func_228303_a_(-10.0F, -14.0F, -28.0F, 20.0F, 27.0F, 26.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, 0.0F, -27.0F);
        torso.addChild(head);
        setRotationAngle(head, -0.2618F, 0.0F, 0.0F);
        head.setTextureOffset(76, 54).func_228303_a_(-4.0F, 0.0F, -8.0F, 8.0F, 15.0F, 10.0F, 0.0F, false);
        head.setTextureOffset(67, 0).func_228303_a_(-6.0F, -6.0F, -9.9F, 12.0F, 10.0F, 12.0F, 0.0F, false);
        ...
        horn_r1.setTextureOffset(0, 0).func_228303_a_(-1.0F, -4.5F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, true);
        horn_r1.setTextureOffset(11, 1).func_228303_a_(1.0F, -0.5F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, true);
        horn_r1.setTextureOffset(11, 1).func_228303_a_(10.0F, -0.5F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
        horn_r1.setTextureOffset(0, 0).func_228303_a_(13.0F, -4.5F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);
        ...
        left_ear.setTextureOffset(0, 23).func_228303_a_(0.0F, -1.0F, 0.0F, 5.0F, 2.0F, 1.0F, 0.0F, false);
        ...
        right_ear.setTextureOffset(0, 23).func_228303_a_(-5.0F, -1.0F, 0.0F, 5.0F, 2.0F, 1.0F, 0.0F, true);

        beard = new AdvancedModelBox(this);
        beard.setRotationPoint(0.0F, 15.0F, 1.0F);
        head.addChild(beard);
        setRotationAngle(beard, 0.2182F, 0.0F, 0.0F);
        beard.setTextureOffset(0, 0).func_228303_a_(0.0F, -5.0F, -5.0F, 0.0F, 13.0F, 10.0F, 0.0F, false);

        left_arm = new AdvancedModelBox(this);
        left_arm.setRotationPoint(7.8F, 10.0F, -15.0F);
        torso.addChild(left_arm);
        left_arm.setTextureOffset(93, 23).func_228303_a_(-3.0F, 3.0F, -3.0F, 5.0F, 13.0F, 5.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this);
        right_arm.setRotationPoint(-7.8F, 10.0F, -15.0F);
        torso.addChild(right_arm);
        right_arm.setTextureOffset(93, 23).func_228303_a_(-2.0F, 3.0F, -3.0F, 5.0F, 13.0F, 5.0F, 0.0F, true);
