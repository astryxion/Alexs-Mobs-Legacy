...
public class ModelEmu extends AdvancedEntityModel<EntityEmu> {
    ...
    public ModelEmu() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-6.0F, -4.375F, -10.875F, 12.0F, 11.0F, 21.0F, 0.0F, false);

        leg_left = new AdvancedModelBox(this);
        leg_left.setRotationPoint(3.0F, 6.625F, 0.125F);
        body.addChild(leg_left);
        leg_left.setTextureOffset(0, 55).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 11.0F, 2.0F, 0.0F, false);

        legfur_left = new AdvancedModelBox(this);
        legfur_left.setRotationPoint(0.0F, 0.0F, 0.0F);
        leg_left.addChild(legfur_left);
        legfur_left.setTextureOffset(31, 33).func_228303_a_(-2.0F, 0.0F, -2.0F, 4.0F, 3.0F, 4.0F, 0.0F, false);

        foot_left = new AdvancedModelBox(this);
        foot_left.setRotationPoint(0.0F, 11.0F, -1.0F);
        leg_left.addChild(foot_left);
        foot_left.setTextureOffset(0, 10).func_228303_a_(-1.5F, 0.0F, -4.0F, 3.0F, 2.0F, 6.0F, 0.0F, false);

        leg_right = new AdvancedModelBox(this);
        leg_right.setRotationPoint(-3.0F, 6.625F, 0.125F);
        body.addChild(leg_right);
        leg_right.setTextureOffset(0, 55).func_228303_a_(-1.0F, 0.0F, -1.0F, 2.0F, 11.0F, 2.0F, 0.0F, true);

        legfur_right = new AdvancedModelBox(this);
        legfur_right.setRotationPoint(0.0F, 0.0F, 0.0F);
        leg_right.addChild(legfur_right);
        legfur_right.setTextureOffset(31, 33).func_228303_a_(-2.0F, 0.0F, -2.0F, 4.0F, 3.0F, 4.0F, 0.0F, true);

        foot_right = new AdvancedModelBox(this);
        foot_right.setRotationPoint(0.0F, 11.0F, -1.0F);
        leg_right.addChild(foot_right);
        foot_right.setTextureOffset(0, 10).func_228303_a_(-1.5F, 0.0F, -4.0F, 3.0F, 2.0F, 6.0F, 0.0F, true);

        neck1 = new AdvancedModelBox(this);
        neck1.setRotationPoint(0.0F, 0.625F, -9.5F);
        body.addChild(neck1);
        neck1.setTextureOffset(41, 41).func_228303_a_(-3.0F, -9.0F, -6.0F, 6.0F, 12.0F, 6.0F, 0.0F, false);

        neck2 = new AdvancedModelBox(this);
        neck2.setRotationPoint(0.0F, -8.5F, -2.0F);
        neck1.addChild(neck2);
        neck2.setTextureOffset(46, 0).func_228303_a_(-2.0F, -7.0F, -2.0F, 4.0F, 7.0F, 4.0F, 0.0F, false);
        ...
        head.setTextureOffset(0, 0).func_228303_a_(-2.0F, -4.0F, -3.0F, 5.0F, 4.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(71, 54).func_228303_a_(0.5F, -6.0F, -3.0F, 0.0F, 6.0F, 7.0F, 0.0F, false);

        beak = new AdvancedModelBox(this);
        beak.setRotationPoint(0.5F, -1.0F, -3.0F);
        head.addChild(beak);
        beak.setTextureOffset(46, 12).func_228303_a_(-2.0F, -1.0F, -3.0F, 4.0F, 2.0F, 3.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, -0.875F, 9.125F);
        body.addChild(tail);
        tail.setTextureOffset(0, 33).func_228303_a_(-5.0F, -0.5F, -5.0F, 10.0F, 11.0F, 10.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityEmu) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
