...
public class ModelDevilsHolePupfish extends AdvancedEntityModel<EntityDevilsHolePupfish> {
    ...
    public ModelDevilsHolePupfish() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-1.5F, -2.0F, -5.0F, 3.0F, 4.0F, 9.0F, 0.0F, false);

        bottom_fin = new AdvancedModelBox(this, "bottom_fin");
        bottom_fin.setRotationPoint(0.0F, 2.0F, 1.0F);
        body.addChild(bottom_fin);
        bottom_fin.setTextureOffset(0, 0).func_228303_a_(0.0F, 0.0F, 0.0F, 0.0F, 2.0F, 3.0F, 0.0F, false);

        dorsal_fin = new AdvancedModelBox(this, "dorsal_fin");
        dorsal_fin.setRotationPoint(0.0F, -2.0F, 0.0F);
        body.addChild(dorsal_fin);
        dorsal_fin.setTextureOffset(11, 14).func_228303_a_(0.0F, -3.0F, -2.0F, 0.0F, 3.0F, 5.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -1.0F, 4.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 14).func_228303_a_(0.0F, -3.0F, 0.0F, 0.0F, 6.0F, 5.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(0, 14).func_228303_a_(0.0F, -1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(0, 14).func_228303_a_(0.0F, -1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, true);
        this.updateDefaultPose();
    }

    public void setRotationAngles(EntityDevilsHolePupfish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.progressRotationPrev(dorsal_fin, limbSwingAmount, 0F, 0, 0, 1F);
        this.progressPositionPrev(dorsal_fin, limbSwingAmount, 0, 0.5F, 0, 1F);
        this.progressRotationPrev(bottom_fin, limbSwingAmount, 0F, 0, 0, 1F);
        this.progressPositionPrev(bottom_fin, limbSwingAmount, 0, -0.5F, -0.5F, 1F);
        this.progressRotationPrev(body, landProgress, 0, 0, 0F, 5F);
        ...
        this.body.rotateAngleX += feedingProgress * (float) Math.cos(ageInTicks * 0.3F) * 0.2F * (float) Math.PI * 0.1F;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        setRotationAngles((EntityDevilsHolePupfish) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
