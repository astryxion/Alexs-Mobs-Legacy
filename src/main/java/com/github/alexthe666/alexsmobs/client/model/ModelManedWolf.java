...
public class ModelManedWolf extends AdvancedEntityModel<EntityManedWolf> {
    ...
    public ModelManedWolf() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-3.0F, -4.0F, -10.0F, 6.0F, 8.0F, 17.0F, 0.0F, false);
        body.setTextureOffset(0, 26).func_228303_a_(-3.5F, -4.4F, -10.1F, 7.0F, 5.0F, 8.0F, 0.0F, false);

        neck = new AdvancedModelBox(this, "neck");
        neck.setRotationPoint(0.0F, -1.0F, -9.0F);
        body.addChild(neck);
        setRotationAngle(neck, -0.6545F, 0.0F, 0.0F);
        neck.setTextureOffset(30, 0).func_228303_a_(-2.5F, -3.0F, -6.0F, 5.0F, 5.0F, 7.0F, 0.0F, false);
        neck.setTextureOffset(42, 39).func_228303_a_(-1.5F, -6.0F, -5.0F, 3.0F, 3.0F, 6.0F, 0.0F, false);
        ...
        head.setTextureOffset(0, 40).func_228303_a_(-3.0F, -2.0F, -4.0F, 6.0F, 5.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(44, 22).func_228303_a_(-1.5F, 0.0F, -8.0F, 3.0F, 3.0F, 4.0F, 0.0F, false);
        ...
        left_ear.setTextureOffset(47, 13).func_228303_a_(-1.0F, -5.0F, -0.4F, 3.0F, 6.0F, 1.0F, 0.0F, false);
        ...
        right_ear.setTextureOffset(47, 13).func_228303_a_(-2.0F, -5.0F, -0.4F, 3.0F, 6.0F, 1.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -2.0F, 7.0F);
        body.addChild(tail);
        tail.setTextureOffset(31, 26).func_228303_a_(-2.0F, -1.0F, -1.0F, 4.0F, 14.0F, 4.0F, 0.0F, false);

        left_arm = new AdvancedModelBox(this, "left_arm");
        left_arm.setRotationPoint(1.8F, 5.0F, -8.0F);
        body.addChild(left_arm);
        left_arm.setTextureOffset(0, 0).func_228303_a_(-1.0F, -1.0F, -1.0F, 2.0F, 13.0F, 2.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this, "right_arm");
        right_arm.setRotationPoint(-1.8F, 5.0F, -8.0F);
        body.addChild(right_arm);
        right_arm.setTextureOffset(0, 0).func_228303_a_(-1.0F, -1.0F, -1.0F, 2.0F, 13.0F, 2.0F, 0.0F, true);

        left_leg = new AdvancedModelBox(this, "left_leg");
        left_leg.setRotationPoint(2.0F, 3.0F, 5.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(23, 42).func_228303_a_(-0.8F, -2.0F, -0.9F, 2.0F, 16.0F, 3.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setRotationPoint(-2.0F, 3.0F, 5.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(23, 42).func_228303_a_(-1.2F, -2.0F, -0.9F, 2.0F, 16.0F, 3.0F, 0.0F, true);
        this.updateDefaultPose();
    }

    public Iterable<ModelRenderer> getParts() { return ImmutableList.of(root); }
    ...
    public void setRotationAngles(EntityManedWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        this.left_ear_pivot.rotateAngleX += earPitch * 0.017453292F;
        this.left_ear_pivot.rotateAngleY += earYaw * 0.017453292F;
        this.right_ear_pivot.rotateAngleX += earPitch * 0.017453292F;
        this.right_ear_pivot.rotateAngleY -= earYaw * 0.017453292F;
        this.head.rotateAngleY += netHeadYaw * 0.5F * 0.017453292F;
        ...
        float f2 = 0.2F * danceProgress * 6F * MathHelper.cos(ageInTicks * 0.5F + 0) * 0.3F * (danceProgress * 0.2F) + 0 * (danceProgress * 0.2F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        setRotationAngles((EntityManedWolf) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }

    @Override
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityManedWolf wolf = (EntityManedWolf) entity;
        if (wolf.isChild()) {
            this.head.setScale(1.35F, 1.35F, 1.35F);
            this.head.setShouldScaleChildren(true);
            this.left_arm.setScale(1, 0.8F, 1);
            this.right_arm.setScale(1, 0.8F, 1);
            this.left_leg.setScale(1, 0.8F, 1);
            this.right_leg.setScale(1, 0.8F, 1);
            net.minecraft.client.renderer.GlStateManager.pushMatrix();
            net.minecraft.client.renderer.GlStateManager.scale(0.65F, 0.65F, 0.65F);
            net.minecraft.client.renderer.GlStateManager.translate(0.0D, 1.0D, 0.125D);
            getParts().forEach(part -> part.render(f5));
            net.minecraft.client.renderer.GlStateManager.popMatrix();
        } else {
            this.head.setScale(1F, 1F, 1F);
            this.left_arm.setScale(1, 1, 1);
            this.right_arm.setScale(1, 1, 1);
            this.left_leg.setScale(1, 1, 1);
            this.right_leg.setScale(1, 1, 1);
            getParts().forEach(part -> part.render(f5));
        }
    }
}
