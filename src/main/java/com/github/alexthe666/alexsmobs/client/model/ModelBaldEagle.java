...
public class ModelBaldEagle extends AdvancedEntityModel<EntityBaldEagle> {
    ...
    public ModelBaldEagle() {
        ...
        head.setTextureOffset(1, 3).func_228303_a_(-1.5F, -4.4F, -1.0F, 3.0F, 6.0F, 3.0F, 0.0F, false);

        topHead = new AdvancedModelBox(this);
        topHead.setRotationPoint(0.0F, -4.9F, -0.5F);
        head.addChild(topHead);
        topHead.setTextureOffset(10, 0).func_228303_a_(-1.5F, -0.5F, -1.5F, 3.0F, 1.0F, 4.0F, 0.0F, false);

        beak1 = new AdvancedModelBox(this);
        beak1.setRotationPoint(0.0F, -3.5F, -0.7F);
        head.addChild(beak1);
        setRotationAngle(beak1, -0.1745F, 0.0F, 0.0F);
        beak1.setTextureOffset(21, 9).func_228303_a_(-0.5F, -1.0F, -1.94F, 1.0F, 2.0F, 2.0F, 0.0F, false);

        beak2 = new AdvancedModelBox(this);
        beak2.setRotationPoint(0.0F, -1.0F, -2.54F);
        beak1.addChild(beak2);
        beak2.setTextureOffset(16, 9).func_228303_a_(-0.5F, 0.01F, -0.4F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        ...
        hood_tie.setTextureOffset(40, -4).func_228303_a_(0.0F, -4.0F, -2.0F, 0.0F, 5.0F, 4.0F, 0.0F, false);

        hood = new AdvancedModelBox(this);
        hood.setRotationPoint(0.0F, -4.9F, -0.5F);
        head.addChild(hood);
        hood.setTextureOffset(36, 7).func_228303_a_(-1.5F, -0.5F, -1.5F, 3.0F, 4.0F, 4.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityBaldEagle) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        if (this.isChild) {
            ...
            GlStateManager.translate(0.0F, 1.5F, 0F);
