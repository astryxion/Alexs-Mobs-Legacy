...
public class ModelCrimsonMosquito extends AdvancedEntityModel<EntityCrimsonMosquito> {
	...
	public ModelCrimsonMosquito() {
		...
		root.addChild(body);
		body.setTextureOffset(31, 65).func_228303_a_(-3.0F, -3.5F, -3.75F, 6.0F, 6.0F, 6.0F, 0.0F, false);

		wingL = new AdvancedModelBox(this);
		wingL.setRotationPoint(2.7F, -3.2F, -0.75F);
		body.addChild(wingL);
		wingL.setTextureOffset(37, 59).func_228303_a_(0.0F, 0.0F, -1.0F, 18.0F, 0.0F, 5.0F, 0.0F, false);

		wingR = new AdvancedModelBox(this);
		wingR.setRotationPoint(-2.7F, -3.2F, -0.75F);
		body.addChild(wingR);
		wingR.setTextureOffset(37, 53).func_228303_a_(-18.0F, 0.0F, -1.0F, 18.0F, 0.0F, 5.0F, 0.0F, false);
		...
		legL1.setTextureOffset(0, 51).func_228303_a_(0.0F, -8.0F, 0.0F, 18.0F, 15.0F, 0.0F, 0.0F, false);

		legL2 = new AdvancedModelBox(this);
		legL2.setRotationPoint(0.0F, 0.0F, 0.4F);
		legsL.addChild(legL2);
		legL2.setTextureOffset(37, 16).func_228303_a_(0.0F, -8.0F, 0.0F, 18.0F, 15.0F, 0.0F, 0.0F, false);
		...
		legL3.setTextureOffset(37, 0).func_228303_a_(0.0F, -8.0F, 0.0F, 18.0F, 15.0F, 0.0F, 0.0F, false);
		...
		legR1.setTextureOffset(37, 37).func_228303_a_(-18.0F, -8.0F, 0.0F, 18.0F, 15.0F, 0.0F, 0.0F, false);

		legR2 = new AdvancedModelBox(this);
		legR2.setRotationPoint(0.0F, 0.0F, 0.4F);
		legsR.addChild(legR2);
		legR2.setTextureOffset(0, 35).func_228303_a_(-18.0F, -8.0F, 0.0F, 18.0F, 15.0F, 0.0F, 0.0F, false);
		...
		legR3.setTextureOffset(0, 19).func_228303_a_(-18.0F, -8.0F, 0.0F, 18.0F, 15.0F, 0.0F, 0.0F, false);

		tail = new AdvancedModelBox(this);
		tail.setRotationPoint(0.0F, -1.5F, 2.25F);
		body.addChild(tail);
		tail.setTextureOffset(48, 83).func_228303_a_(-2.0F, -1.4F, 0.0F, 4.0F, 4.0F, 16.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, 0.5F, -3.75F);
		body.addChild(head);
		head.setTextureOffset(56, 65).func_228303_a_(-2.0F, -2.0F, -4.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
		...
		antennaL.setTextureOffset(5, 0).func_228303_a_(0.0F, -8.0F, 0.0F, 0.0F, 8.0F, 2.0F, 0.0F, false);
		...
		antennaR.setTextureOffset(0, 0).func_228303_a_(0.0F, -8.0F, 0.0F, 0.0F, 8.0F, 2.0F, 0.0F, false);

		mouth = new AdvancedModelBox(this);
		mouth.setRotationPoint(0.0F, 2.0F, -3.5F);
		head.addChild(mouth);
		setRotationAngle(mouth, -1.0036F, 0.0F, 0.0F);
		mouth.setTextureOffset(23, 0).func_228303_a_(-0.5F, 0.0F, -1.0F, 1.0F, 8.0F, 1.0F, 0.0F, false);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCrimsonMosquito) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
