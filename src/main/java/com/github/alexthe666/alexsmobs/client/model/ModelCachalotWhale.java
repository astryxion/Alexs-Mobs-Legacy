...
public class ModelCachalotWhale extends AdvancedEntityModel<EntityCachalotWhale> {
    ...
    public ModelCachalotWhale() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-21.0F, -30.0F, -60.0F, 42.0F, 60.0F, 112.0F, 0.0F, false);

        top_fin = new AdvancedModelBox(this);
        top_fin.setRotationPoint(0.0F, -34.0F, 42.0F);
        body.addChild(top_fin);
        top_fin.setTextureOffset(0, 0).func_228303_a_(-3.0F, -4.0F, -10.0F, 6.0F, 8.0F, 20.0F, 0.0F, false);

        arm_left = new AdvancedModelBox(this);
        arm_left.setRotationPoint(21.0F, 26.0F, -38.0F);
        body.addChild(arm_left);
        arm_left.setTextureOffset(304, 220).func_228303_a_(0.0F, -2.0F, -3.0F, 36.0F, 4.0F, 21.0F, 0.0F, false);

        arm_right = new AdvancedModelBox(this);
        arm_right.setRotationPoint(-21.0F, 26.0F, -38.0F);
        body.addChild(arm_right);
        arm_right.setTextureOffset(304, 220).func_228303_a_(-36.0F, -2.0F, -3.0F, 36.0F, 4.0F, 21.0F, 0.0F, true);

        tail1 = new AdvancedModelBox(this);
        tail1.setRotationPoint(0.0F, -1.0F, 52.0F);
        body.addChild(tail1);
        tail1.setTextureOffset(163, 227).func_228303_a_(-15.0F, -22.0F, 0.0F, 30.0F, 45.0F, 80.0F, 0.0F, false);

        tail2 = new AdvancedModelBox(this);
        tail2.setRotationPoint(0.0F, -1.0F, 80.0F);
        tail1.addChild(tail2);
        tail2.setTextureOffset(197, 0).func_228303_a_(-9.0F, -14.0F, 0.0F, 18.0F, 28.0F, 65.0F, 0.0F, false);

        tail3 = new AdvancedModelBox(this);
        tail3.setRotationPoint(0.0F, 2.0F, 56.0F);
        tail2.addChild(tail3);
        tail3.setTextureOffset(158, 173).func_228303_a_(-33.0F, -5.0F, -5.0F, 66.0F, 9.0F, 37.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -2.0F, -60.0F);
        body.addChild(head);
        head.setTextureOffset(0, 173).func_228303_a_(-18.0F, -28.0F, -85.0F, 36.0F, 48.0F, 85.0F, 0.0F, false);

        jaw = new AdvancedModelBox(this);
        jaw.setRotationPoint(0.0F, 20.0F, 0.0F);
        head.addChild(jaw);
        jaw.setTextureOffset(293, 23).func_228303_a_(-7.0F, 0.0F, -71.0F, 14.0F, 9.0F, 71.0F, 0.0F, false);

        teeth = new AdvancedModelBox(this);
        teeth.setRotationPoint(0.0F, 0.0F, -7.0F);
        jaw.addChild(teeth);
        teeth.setTextureOffset(32, 370).func_228303_a_(-4.0F, -4.0F, -59.0F, 8.0F, 4.0F, 60.0F, 0.0F, false);
        this.updateDefaultPose();
    }

    /**
     * Matches 1.16 child rendering: enlarged head + scaled child body via {@link com.github.alexthe666.alexsmobs.client.render.RenderCachalotWhale}.
     */
    public void setChildHeadScale(boolean child) {
        if (child) {
            float f = 1.25F;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntityCachalotWhale) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
