...
public class ModelTarantulaHawkBaby extends AdvancedEntityModel<EntityTarantulaHawk> {
    ...
    public ModelTarantulaHawkBaby() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 0).func_228303_a_(-4.0F, -3.0F, 0.0F, 8.0F, 6.0F, 15.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, 0.9F, 0.0F);
        body.addChild(head);
        head.setTextureOffset(0, 22).func_228303_a_(-3.5F, -3.0F, -3.0F, 7.0F, 5.0F, 3.0F, 0.0F, false);
