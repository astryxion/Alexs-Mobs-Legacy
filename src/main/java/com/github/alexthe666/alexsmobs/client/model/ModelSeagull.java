...
public class ModelSeagull extends AdvancedEntityModel<EntitySeagull> {
	...
	public ModelSeagull() {
		...
		root.addChild(body);
		body.setTextureOffset(0, 0).func_228303_a_(-2.0F, -2.5F, -4.5F, 4.0F, 5.0F, 9.0F, 0.0F, false);

		tail = new AdvancedModelBox(this);
		tail.setRotationPoint(0.0F, -1.5F, 4.5F);
		body.addChild(tail);
		setRotationAngle(tail, -0.3927F, 0.0F, 0.0F);
		tail.setTextureOffset(18, 0).func_228303_a_(-1.5F, 0.0F, 0.0F, 3.0F, 2.0F, 5.0F, 0.0F, false);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -0.5F, -4.0F);
		body.addChild(head);
		head.setTextureOffset(16, 26).func_228303_a_(-1.5F, -6.0F, -1.5F, 3.0F, 8.0F, 3.0F, 0.0F, false);

		beak = new AdvancedModelBox(this);
		beak.setRotationPoint(0.0F, -4.0F, -1.5F);
		head.addChild(beak);
		beak.setTextureOffset(11, 15).func_228303_a_(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);

		left_wing = new AdvancedModelBox(this);
		left_wing.setRotationPoint(2.0F, -1.5F, -2.5F);
		body.addChild(left_wing);
		left_wing.setTextureOffset(0, 15).func_228303_a_(0.0F, -1.0F, -1.0F, 1.0F, 4.0F, 8.0F, 0.0F, false);
		...
		left_wingtip_r1.setTextureOffset(19, 15).func_228303_a_(0.0F, -1.5F, 0.0F, 0.0F, 3.0F, 7.0F, 0.0F, false);

		right_wing = new AdvancedModelBox(this);
		right_wing.setRotationPoint(-2.0F, -1.5F, -2.5F);
		body.addChild(right_wing);
		right_wing.setTextureOffset(0, 15).func_228303_a_(-1.0F, -1.0F, -1.0F, 1.0F, 4.0F, 8.0F, 0.0F, true);
		...
		right_wingtip_r1.setTextureOffset(19, 15).func_228303_a_(0.0F, -1.5F, 0.0F, 0.0F, 3.0F, 7.0F, 0.0F, true);

		left_leg = new AdvancedModelBox(this);
		left_leg.setRotationPoint(1.0F, 2.5F, 2.0F);
		body.addChild(left_leg);
		left_leg.setTextureOffset(27, 8).func_228303_a_(-1.0F, 0.0F, -3.0F, 3.0F, 4.0F, 3.0F, 0.0F, false);

		right_leg = new AdvancedModelBox(this);
		right_leg.setRotationPoint(-1.0F, 2.5F, 2.0F);
		body.addChild(right_leg);
		right_leg.setTextureOffset(27, 8).func_228303_a_(-2.0F, 0.0F, -3.0F, 3.0F, 4.0F, 3.0F, 0.0F, true);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, Entity entityIn) {
        setRotationAngles((EntitySeagull) entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
    }
